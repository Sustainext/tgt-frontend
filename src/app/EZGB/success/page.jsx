  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4 bg-[#2ae4ff0d]">
      ...
      <div className="bg-white rounded-2xl shadow-2xl px-8 py-8 max-w-md w-full flex flex-col">
        ...
        {/* Subtitle */}
        <p className="text-sm text-gray-500 mb-2 w-full text-left">
          Your utility account is now authorized.
        </p>
        <p className="text-sm text-gray-500 w-full mb-2 text-left">
          It might take some time for your data to reflect on the Sustainext platform.
        </p>
