...
export default function ProfileSettings({
  ...
  setLoading
    ...
    const [numberWithoutCountryCode, setnumberWithoutCountryCode] =
      useState("");
    const [firstName, setFirstName] = useState(capitalizeName(userProfileData.firstname?userProfileData.firstname:''));
    const [lastName, setLastName] = useState(capitalizeName(userProfileData.lastname?userProfileData.lastname:''));
    ...
    const [preview, setPreview] = useState(userProfileData.profile_pic?userProfileData.profile_pic:null);
    ...
    const handleSubmit= async (e)=>{
        try{
            ...
            if(
                (preview !== null && userProfileData?.profile_pic === null && image !== null) ||
                (preview === null && userProfileData?.profile_pic !== null && image === null) ||
                (preview !== null && userProfileData?.profile_pic !== null && image !== null)
            ){
