...
import { IoClose, IoCheckmarkCircle, IoAlertCircle, IoDocument, IoPerson, IoTime, IoNotifications } from 'react-icons/io5';
...
const NotificationsModal = ({ isOpen, onClose, triggerRef }) => {
  ...
  const [allNotifications, setAllNotifications] = useState([
    {
      ...
      description: 'Q4 2024 sustainability report needs your approval before submission to GRI standards',
    ...
    },
    {
      ...
      description: 'New Scope 2 emissions data from renewable energy sources has been processed', 
    ...
    },
    {
      ...
      description: 'EU Corporate Sustainability Reporting Directive submission due in 15 days',
    ...
    },
    {
      ...
      description: 'Complete ESG risk assessment for 3 tier-1 suppliers by end of week',
      timestamp: '1 day ago',
      isUnread: true,
      avatar: null,
    ...
    },
    {
      ...
      description: 'Congratulations! 25% waste reduction goal has been reached ahead of schedule',
    ...
    },
    {
      ...
      description: 'Inconsistencies found in water consumption data for manufacturing site B',
    ...
    },
    {
      ...
      description: 'Annual stakeholder materiality assessment survey is ready for distribution',
    ...
    },
    {
      ...
      description: 'TCFD recommendations have been updated - review impact on current reporting',
  ...
  const handleActionClick = async (notification, e) => {
    ...
    try {
      await new Promise(resolve => setTimeout(resolve, 1000));
      console.log(`Action: ${notification.actionLink} for notification ${notification.id}`);
    } catch (error) {
  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center py-12 px-6 text-center">
      ...
      <p className="text-sm text-gray-500 max-w-sm">
        No new notifications to show. We'll let you know when something needs your attention.
      </p>
    </div>
  );
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <p className={`text-sm mb-1 transition-all ${
