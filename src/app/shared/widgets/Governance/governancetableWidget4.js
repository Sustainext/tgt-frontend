                                    ...
                                    <>
                                        ...
                                        {internalValue[rowIndex]?.column1 === "Yes" && (
                                            <input
                                                ...
                                                className="text-sm pl-2 py-2 mt-2 w-full border-b"
                                            />
                                        )}
                                    </>
                                )}
                            ...
                            {internalValue[rowIndex]?.fileName ? (
                                <label className="flex cursor-pointer">
                                    <div className="flex items-center text-center mt-2 ">
                                        <div className=" text-sky-600 text-sm flex text-center w-[180px] truncate">

                                            <p className=" text-sky-600 text-sm flex justify-center"> <MdFilePresent className="w-6 h-6 mr-1 text-green-500" />{internalValue[rowIndex]?.fileName}</p>
                                        </div>
                                    </div>
                                </label>
                            ) : (
                                <label htmlFor={`fileInput-${rowIndex}`} className="flex cursor-pointer">
                                    <div className="flex text-center mt-2 ">
                                        ...
                                        <div className=" truncate text-center text-[#007EEF] text-sm ml-1">
