          ...
          {formData.map((entry, index) => (
            <div key={index} className="flex mb-4">
              <div className="mx-2 relative mb-4">
                {index === 0 && (
                  <label className="font-medium text-gray-700 text-[13px] 4k:text-[15px] w-[20vw] 4k:w-[8vw] h-[35px] flex mb-1">
                ...
                <input
                  ...
                  className={`block w-[20vw] 4k:w-[8vw] ${index === 0 ? "py-2" : "py-1.5"} text-[12px] leading-6 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:leading-5 border-b-2 border-gray-300`}
                  value={entry.Q2 || ""}
              ...
              <div className="mx-2 relative mb-4">
                {index === 0 && (
                  <label className="font-medium text-gray-700 text-[13px] 4k:text-[15px] w-[20vw] 4k:w-[8vw] h-[35px] flex mb-2">
                ...
                <select
                  className={`block w-[20vw] 4k:w-[8vw] py-2 text-[12px] 4k:text-[14px] leading-6 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:leading-5 border-b-2 border-gray-300`}
                  value={entry.Q3 || ""}
              ...
              <div className="mx-2 relative mb-4">
                {index === 0 && (
                  <label className="flex font-medium text-gray-700 text-[13px] 4k:text-[15px] w-[20vw] 4k:w-[8vw] h-[35px] mb-2">
              ...
              <div className="mx-2 relative mb-4">
                ...
                <Select
                  ...
                  className={` w-[20vw] 4k:w-[8vw] text-[12px] `}
                />
              </div>
              ...
              <div className="mx-2 relative mb-4">
  {index === 0 && (
                  <label className="flex font-medium text-gray-700 text-[13px] 4k:text-[15px] w-[20vw] 4k:w-[9vw] h-[35px] mb-2">
                ...
                <input
                  type="text"
                  placeholder="Enter Data"
                  className={`block w-[20vw] 4k:w-[9vw] py-2 text-[12px] 4k:text-[14px] leading-6 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:leading-5 border-b-2 border-gray-300`}
                  value={entry.Q10 || ""}
