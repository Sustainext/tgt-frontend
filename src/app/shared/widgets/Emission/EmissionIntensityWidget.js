      ...
      {rows.map((item, rowIndex) => (
        <div className="mb-4 px-2 flex gap-4" key={rowIndex}>
          <div className="relative">
            ...
            <select
              className="block w-[71vw] xl:w-[20vw] md:w-[33vw] lg:w-[20vw] 2xl:w-[20vw] 2k:w-[20vw] 4k:w-[8vw] py-2 text-[12px] 4k:text-[14px] border-b-2 border-gray-300 focus:outline-none"
          ...
          <div className="relative">
            ...
            {["Units of product sold", "Number of employees"].includes(
              ...
              <Select
                ...
                className="block w-[71vw] xl:w-[20vw] md:w-[33vw] lg:w-[20vw] 2xl:w-[20vw] 2k:w-[20vw]  4k:w-[10vw] text-[12px] border-b-2 border-gray-300 focus:outline-none"
              />
            ) : (
              <select
                className="block w-[71vw] xl:w-[20vw] md:w-[33vw] lg:w-[20vw] 2xl:w-[20vw] 2k:w-[20vw]  4k:w-[8vw] py-2 text-[12px] 4k:text-[14px] border-b-2 border-gray-300 focus:outline-none"
          ...
          <div className="relative">
            ...
            <Select
              ...
              className="block  w-[73vw] xl:w-[25vw] md:w-[40vw] lg:w-[25vw] 2xl:w-[25vw] 2k:w-[25vw]  4k:w-[10vw] text-[12px] border-b-2 border-gray-300 focus:outline-none"
            />
            <ReactTooltip
