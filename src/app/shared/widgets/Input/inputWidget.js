  ...
  return (
    <div className="mb-3 px-1">
      ...
      <div className="relative">
        <input
          className={`block w-[20vw] 4k:w-[8vw] py-2 text-[12px] 4k:text-[14px] leading-6 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:leading-5 border-b-2 ${hasError ? 'border-red-500' : 'border-gray-300'}`}
