      ...
      <div className="mb-6">
        ...
        {inputType === 'text' ? (
          <textarea
            ...
            className="border appearance-none text-xs border-gray-400 text-neutral-600 pl-2 rounded-md py-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 w-full"
            value={value}
