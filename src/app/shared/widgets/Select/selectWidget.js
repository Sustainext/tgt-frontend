  ...
  return (
    <div className="mb-3 px-1">
      ...
      <div className="relative">
        ...
        {!showOtherInput ? (
          <select
            className={`block w-[20vw] 4k:w-[8vw] py-2 text-[12px] 4k:text-[14px] p-0 custom-select focus:outline-none focus:border-blue-300 border-b-2 border-gray-300 capitalize table-scrollbar ${hasError ? 'border-red-500' : 'border-gray-300'}`}
            value={value}
          ...
          <input
            type="text"
            className={`block w-[20vw] 4k:w-[8vw] py-2 text-[12px] 4k:text-[14px] border-b-2 border-gray-300 ${
