  ...
  return (
    <div className="mb-3 px-1">
      {id.startsWith("root_0") && (
        ...
        >
          <p
            className={`flex text-[13px] h-[35px] text-neutral-950 font-[400] mb-1 ${
              label !== "Metric Unit" && schema.display !== "none" ? "pl-5" : ""
            }`}
          >
            {label}
            <MdInfoOutline
              ...
              className={`mt-1   text-[14px] ${
                label !== "Metric Unit" ? "ml-5 w-[30px]" : "w-[20px] ml-1"
              }`}
...
export default SelectWidgetuit;
