...
const DisabledTextAreaWidget = ({
  ...
  return (
    <div className="mb-3 px-1">
      {/* Conditionally show label and tooltip based on the id */}
        ...
        <div className="relative w-[68%]">
          ...
          {id.startsWith("root_0") && (
            <>
             <p className="flex text-[13px]  w-[56vw] xl:w-[20vw] lg:w-[20vw] md:w-[20vw] 2xl:w-[20vw]  4k:w-[8vw]  h-[35px] text-neutral-950 font-[400] mb-1 leading-[15px]">
            {label}
            <MdInfoOutline
      ...
      <div>
        <textarea
          className={`block  w-[56vw] xl:w-[20vw] lg:w-[20vw] md:w-[20vw] 2xl:w-[20vw]  4k:w-[8vw] py-2  text-[12px] h-[38px]  leading-6 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:leading-5 border-b-2 border-gray-300 ${hasError ? 'border-red-500' : 'border-gray-300'}`}
