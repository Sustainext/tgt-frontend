  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title:
          "Specify details about the measures taken by the organization to support rights to exercise freedom of association and collective bargaining.",
      },
    },
  },
};
  ...
  items: {
    ...
    Q1: {
      "ui:title":
        "Specify details about the measures taken by the organization to support rights to exercise freedom of association and collective bargaining.",
      "ui:tooltip":
        "Please mention the measures taken by the organization to support rights to exercise freedom of association and collective bargaining.",
