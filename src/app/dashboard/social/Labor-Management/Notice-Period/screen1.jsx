...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "Standard notice period for all employees (in weeks)",
      },
    },
  },
};
...
const Screen1 = ({ location, year, month }) => {
 ...
 typically provided to employees before significant operational changes that could
...
significant positive or negative impacts on workers performing the organization’s activities."
