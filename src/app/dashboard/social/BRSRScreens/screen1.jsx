...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      Q1: { type: "string", title: "Does your organization fall under the applicability of CSR provisions as per Section 135 of the Companies Act, 2013?",
        enum:[
            "Yes",
            "No"
        ]
...
const uiSchema = {
    ...
    "ui:options": {
      titles: [
        {
          key: "Q1",
          title: "Does your organization fall under the applicability of CSR provisions as per Section 135 of the Companies Act, 2013?",
          tooltip:
            "<p>Indicate whether CSR is applicable as per section 135 of Companies Act, 2013 <br/> The provisions of CSR apply to every company fulfilling any of the <br/> following conditions in the immediately preceding financial year:<br/> Net worth of more than ₹500 crore<br/> Turnover of more than ₹1,000 crore<br/> Net profit of more than ₹5 crore</p>",
          layouttype: "select",
