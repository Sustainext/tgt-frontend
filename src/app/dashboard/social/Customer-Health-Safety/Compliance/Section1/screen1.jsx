  ...
  items: {
    ...
    Q1: {
      "ui:title":
        "Total number of Incidents of non-compliance with regulations resulting in a fine or penalty",
      "ui:tooltip":
        "Please specify the total number of incidents of non-compliance with regulations resulting in a fine or penalty. ",
...
period"
            ...
            <p className="text-[15px] mx-2 text-gray-500 font-semibold">
