...
const uiSchema = {
    ...
    'ui:options': {
        titles:
            [
                { title: "Suppliers in which workers’ rights to exercise freedom of association or collective bargaining may be violated or at significant risk", tooltip: "Please specify the name and type of suppliers in which workers’ rights to exercise freedom of association or collective bargaining may be violated or at significant risk." },
                { title: "Type of Operation", tooltip: "This section allows you to enter the type of suppliers in which workers’ rights to exercise freedom of association or collective bargaining may be violated or at significant risk.  " },
...
or collective bargaining may be violated or at significant risk." className="mt-1.5 ml-2 text-[15px]" />
