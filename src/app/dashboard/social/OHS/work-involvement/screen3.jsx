...
const uiSchema = {
  ...
  "ui:options": {
    titles: [
      {
        title: "Formal joint management-worker health and safety committees",
        tooltip:
          "Provide a description of formal joint management-worker health and safety committees1",
      },
      {
        title: "Responsibilities",
        tooltip: "What are the chairing responsibilities of the committee?",
      },
      {
      ...
      },
      {
        ...
        tooltip: "Explain the decision-making authority of the committee",
      },
      {
        title: "Exclusions (if any) & Reason for Exclusions",
        tooltip:
...
const Screen3 = ({ location, year, month }) => {
  ...
  return (
    <>
      <div
        className="mx-2 pb-8 pt-3 px-3 mb-6 rounded-md"
        style={{
          boxShadow:
      ...
      >
        <div className="flex">
          <div className="w-[80%] relative">
            <h2 className="flex mx-2 text-[15px] font-[500] mb-6">
              Formal joint management-worker health and safety committees
              <MdInfoOutline
                data-tooltip-id={`tooltip-$e145`}
