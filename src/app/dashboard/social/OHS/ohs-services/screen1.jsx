...
const uiSchema = {
  items: {
    ...
    Q1: {
      "ui:title":
        "Describe the occupational health services’ functions that contribute to the identification and elimination of hazards and minimization of risks.",
      "ui:tooltip":
        "Specify the occupational health services’ functions that contribute to the identification and elimination of hazards and minimization of risks.",
