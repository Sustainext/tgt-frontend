...
const uiSchema = {
    items: {
        ...
        Q1: {
            ...
            "ui:tooltip": "select 'Yes' if any workers have been excluded from this disclosure and select 'No' if not. ",
                   ...
                   <h2 className="flex mx-2 text-[15px] font-[500] mb-2">
                    Workers excluded from the disclosure
                        <MdInfoOutline data-tooltip-id={`tooltip-$e1`}
                            ...
                            to the workers excluded from this disclosure. " className="mt-1.5 ml-2 text-[15px]" />
