...
const view_path = "gri-social-ohs-403-8b-workers_excluded";
const client_id = 1;
const user_id = 1;
...
const uiSchema = {
  items: {
    ...
    Q3: {
      ...
      "ui:tooltip":
        "Specify the types of workers that have been excluded.E.g. full-time, part-time, non-guaranteed hours, permanent or temporary basis, type or degree of control (e.g., control of work or workplace, sole or shared control), location etc.",
      "ui:tooltipdisplay": "block",
      "ui:widget": "inputWidget",
      "ui:horizontal": true,
      "ui:options": {
            ...
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-content="This section documents data corresponding
                            ...
                            Include: The types of worker excluded "
