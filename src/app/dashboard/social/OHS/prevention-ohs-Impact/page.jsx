            ...
            <div className="flex flex-col justify-start overflow-x-hidden ">
                <div className="flex justify-between items-center border-b border-gray-200 mb-5 w-full">
                    ...
                    <div className='w-full float-end '>
                        <div className="flex float-end border-l">
                            <button className="text-[#007EEF] bg-slate-200 rounded-full text-[11px] w-[72px] h-[22px] ml-2 text-center pt-0.5" onClick={() => toggleDrawer('34')}>GRI 403 - 7</button>
                ...
                <div className="ml-3 flex">
                    <h6 className="text-[17px] mb-4 font-semibold flex">
                        ...
                        Prevention and mitigation of occupational health & safety related impacts directly linked by business relationships
...
transition-transform duration-300 ease-in-out z-[100] shadow-2xl px-2`}>
            ...
            year={year}
            setYear={setYear} />
            <Preventionohsimpactscreen location={location} year={year} month={activeMonth}/>
            {/* <Riskscreeen /> */}

        </>
    );
};
export default Preventionohsimpact;
