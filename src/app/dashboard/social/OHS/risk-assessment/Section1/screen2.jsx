...
const view_path = "gri-social-ohs-403-2a-quality_assurance-new";
const client_id = 1;
const user_id = 1;
    ...
    titles: [
      {
        ...
        title: "Process Quality Assurance",
        tooltip:
          "Briefly mention key quality assurance practices (e.g., independent audits, feedback mechanisms, data analysis).",
      },
      {
        key: "Personnelcompetency",
        title: "Personnel Competency Assurance",
        tooltip:
          "Describe how you ensure personnel involved in hazard identification, risk assessment, and control implementation have the necessary skills and knowledge. This could include training programs, certifications, experience requirements, or internal competency assessments.",
      },
      {
        key: "Resultsutilization",
        title: "Results Utilization and Improvement",
        tooltip:
          "escribe how you utilize findings from hazard identification, risk assessment, and incident investigations to continuously improve your occupational health and safety management system. (e.g., Analyze results, implement changes, track effectiveness, share lessons learned).",
      },
