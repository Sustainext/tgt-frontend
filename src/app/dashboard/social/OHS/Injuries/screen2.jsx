...
const uiSchema = {
    ...
    'ui:options': {
        titles:
            [
                { title: "Employee Category", tooltip: "Please specify the category of workers who are not employees but whose work and/or workplace is controlled by the organization." },
                { title: "Number of fatalities as a result of work-related injury", tooltip: "Please specify the number of fatalities as a result of work-related injury.Work-related injury: negative impacts on health arising from exposure to hazards at work." },
                { title: "Number of high-consequence work-related injuries (excluding fatalities)", tooltip: "Please specify the number of high-consequence work-related injuries (excluding fatalities).High-consequence work-related injury: work-related injury that results in a fatality or in an injury from  which the worker cannot, does not, or is not expected to \ recover fully to pre-injury health status within six months." },
                { title: "Number of recordable work-related injuries", tooltip: "Please specify the number of recordable work-related injuries. Recordable work-related injury: work-related injury or ill health that results in any of the following: death, days away from work,restricted work or transfer to another job, medical treatment beyond first aid,or loss of consciousness" },
                { title: "Main types of work-related injury", tooltip: "Please specify the main types of work-related injury." },
                { title: "Number of hours worked", tooltip: "Please specify employee's numberof hours worked." },
                    ...
                    <div className='w-[80%]'>
                        <h2 className='flex mx-2 text-[17px] text-gray-500 font-semibold mb-2'>
                            ...
                            <MdInfoOutline data-tooltip-id={`tooltip-$e1`}
                                ...
                                workplace is controlled by the organization." className="mt-1.5 ml-2 text-[14px]" />
