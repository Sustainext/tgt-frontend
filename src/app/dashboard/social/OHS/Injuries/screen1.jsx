    ...
    'ui:options': {
        titles:
            [
                ...
                { title: "Number of recordable work-related injuries", tooltip: "Please specify the number of recordable work-related injuries. Recordable work-related injury: work-related injury or ill health thatresults in any of the following: death, days away from work,restricted work or transfer to another job, medical treatment beyond first aid,or loss of consciousness" },
                { title: "Main types of work-related injury", tooltip: "Please specify the main types of work-related injury." },
                { title: "Number of hours worked", tooltip: "Please specify employee's number of hours worked." },
                    ...
                    <div className='w-[80%]'>
                        ...
                        The Number of Injuries
                            <MdInfoOutline data-tooltip-id={`tooltip-$e1`}
                                ...
                                work-related injury and number of hours worked for all employees. " className="mt-1.5 ml-2 text-[14px]" />
