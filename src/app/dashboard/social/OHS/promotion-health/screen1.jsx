...
const uiSchema = {
    items: {
        ...
        Q1: {
            ...
            "ui:tooltip": "Indicate whether the worker's have access to non-occupational medical and healthcare services",
                ...
                <div className='mb-4 flex'>
                    ...
                    Access to non-occupational medical and healthcare services
                        <MdInfoOutline data-tooltip-id={`tooltip-$e1`}
                            ...
                            medical and healthcare services." className="mt-1.5 ml-2 text-[14px]" />
