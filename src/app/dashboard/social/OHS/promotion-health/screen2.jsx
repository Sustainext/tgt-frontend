...
const uiSchema = {
    items: {
        ...
        Q1: {
            ...
            "ui:tooltip": "Describe the scope of access provided. e.g. The types of service to which access is facilitated and the types of worker that have access to them.",
                ...
                <div className='mb-4 flex'>
                    ...
                    Scope of access
                        <MdInfoOutline data-tooltip-id={`tooltip-$e1`}
                            data-tooltip-content="This section documents data corresponding to the scope of access provided to workers." className="mt-1.5 ml-2 text-[14px]" />
