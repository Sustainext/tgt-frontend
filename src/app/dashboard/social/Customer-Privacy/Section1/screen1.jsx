  ...
  items: {
    ...
    properties: {
      ...
      substantiatedorganization: {
        type: "string",
        title: "substantiatedorganization",
      },
  ...
  "ui:options": {
    titles: [
      ...
      },
      {
        ...
        tooltip:
          "What is the total number of complaints received from outside parties and substantiated by the organization?",
        type: "number",
      },
      {
        title: "Complaints from regulatory bodies",
        tooltip:
          "What is the total number of complaints from regulatory bodies?",
        type: "number",
      },
    ],
  },
