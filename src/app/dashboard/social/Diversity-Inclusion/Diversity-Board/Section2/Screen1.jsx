  ...
  "ui:options": {
    titles: [
      {
        ...
        tooltip: "Please specify the name of the employee category.",
        colSpan: 1,
    ...
    subTitles: [
      ...
      },
      {
        ...
        tooltip:
          "Please specify the type of vulnerable group and the number of individuals from the vulnerable groups present in the organisation's governance body.",
        colSpan: 1,
        type: "number",
        tooltipdispaly: "block",
      },
