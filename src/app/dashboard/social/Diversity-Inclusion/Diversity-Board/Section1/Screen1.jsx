...
const schema = {
  ...
  const uiSchema = {
    ...
    'ui:options': {
      titles: [
        { title: "Number of individuals within the organization’s governance bodies", tooltip: "Please specify the category.", colSpan: 1 },
      ...
      subTitles: [
        ...
        { title: "Total number of individuals with the organisation's governance bodies", tooltip: "Please specify the total number of individuals.", colSpan: 1,type:"number" },
