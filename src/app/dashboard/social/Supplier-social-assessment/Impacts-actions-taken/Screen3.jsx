  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title:
          "Please provide description of significant actual and potential negative social impacts identified in the supply chain.",
      },
    },
  },
};
  ...
  items: {
    ...
    Q1: {
      "ui:title":
        "Please provide description of significant actual and potential negative social impacts identified in the supply chain.",
      "ui:tooltip":
        "Specify and describe significant actual and potential negative social impacts identified in the supply chain.Supply chain: range of activities carried out by entities upstream from the organization, which provide products or services that are used in the development of the organization’s own products or services.",
...
const Screen3 = ({ selectedOrg, selectedCorp, location, year, month,togglestatus }) => {
