...
const view_path = 'gri-social-human_rights-409-1a-suppliers_forced_labor'
const client_id = 1
const user_id = 1
...
const schema = {
    ...
    items: {
        type: 'object',
        properties: {
            compulsorylabor: { type: "string", title: "compulsorylabor" },
...
const uiSchema = {
    ...
    'ui:options': {
        titles:
            [
                { title: "Suppliers considered to have significant risk for incidents of forced or  compulsory labor", tooltip: "Please specify the name and type of suppliers considered to have significant risk for incidents of forced or compulsory labor." },
                { title: "Type of Operation", tooltip: "This section allows you to enter the type of supplier considered to have significant risk for incidents of forced or compulsory labor." },
                       ...
                       <h2 className="flex mx-2 text-[15px] font-[500] mb-2">
                        Suppliers at significant risk for incidents of forced or compulsory labor
                            <MdInfoOutline data-tooltip-id={`tooltip-$e1`}
                                ...
                                compulsory labor." className="mt-1.5 ml-2 text-[15px]" />
