...
const uiSchema = {
    ...
    'ui:options': {
        titles:
            [
                { title: "Operations considered to have significant risk of child labor", tooltip: "Please specify the name and type of operations considered to have significant risk for incidents of forced or compulsory labor." },
                { title: "Type of Operation", tooltip: "This section allows you to enter the type of operation considered to have significant risk for incidents of forced or compulsory labor." },
