...
const view_path = 'gri-social-human_rights-408-1a-1b-supplier_risk_child_labor'
const client_id = 1
const user_id = 1
...
const uiSchema = {
    ...
    'ui:options': {
        titles:
            [
                { title: "Suppliers considered to have significant risk of child labor", tooltip: "Please indicate the suppliers considered to have significant risk for incidents of child labor " },
                { title: "Type of Operation", tooltip: "This section allows you to enter the type of supplier considered to have significant risk for incidents of child labor. " },
                { title: "Countries or Geographic Areas", tooltip: "This section allows you to enter the countries or geographic area with suppliers considered at risk  for incidents of child labor. " },
                    ...
                    <div className='w-[80%]'>
                        ...
                        Suppliers at significant risk for incidents of child labor
                            <MdInfoOutline data-tooltip-id={`tooltip-$e1`}
                                data-tooltip-content="This section documents the data corresponding to the suppliers considered to have significant risk for incidents of child labor." className="mt-1.5 ml-2 text-[14px]" />
