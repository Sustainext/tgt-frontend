...
const uiSchema = {
  ...
  "ui:options": {
    titles: [
      {
        title: "Suppliers considered to have significant risk of child labor",
        tooltip:
          "Please indicate the suppliers considered to have significant risk for incidents of child labor ",
      },
      {
        title: "Type of Operation",
        tooltip:
          "This section allows you to enter the type of supplier considered to have significant risk for incidents of child labor. ",
      },
      {
        title: "Countries or Geographic Areas",
        tooltip:
          "This section allows you to enter the countries or geographic area with suppliers considered at risk  for incidents of child labor. ",
      },
    ],
  },
};
          ...
          <div className="w-[80%] relative">
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-content="This section documents the data corresponding to the suppliers considered to have significant risk for incidents of child labor."
