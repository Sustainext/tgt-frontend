...
const uiSchema = {
  ...
  "ui:options": {
    titles: [
      {
        title: "Operations considered to have significant risk of child labor",
        tooltip:
          "Please indicate the operations considered to have significant risk for incidents of child labor",
      },
      {
      ...
      },
      {
        ...
        tooltip:
          "This section allows you to enter the countries or geographic area with operations considered at risk for incidents of child labor. ",
      },
    ],
  },
};
