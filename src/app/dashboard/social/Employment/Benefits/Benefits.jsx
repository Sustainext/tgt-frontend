...
const schema = {
  ...
  items: {
    ...
    properties: {
      ...
      significantlocation: {
        type: "string",
        title: "Significant location of operations",
      },
    },
  },
};
    ...
    titles: [
      {
        title: "Benefits",
        tooltip:
          "benefit definition: direct benefit provided in the form of financial contributions, care paid for by the organization, or the reimbursement of expenses borne by the employee. Example: Life Insurance, Health Care, Coverage, Parental Leave, Retirement Provision, Stock Ownership etc. ",
      },
      {
        title: "Full-Time Employees",
        tooltip:
          "Please select if this benefit is standard for all full-time employees. Unselect if it's not offered.",
      },
      {
        title: "Part-Time Employees",
        tooltip:
          "Please select if this benefit is standard for all Part-time employees. Unselect if it's not offered.",
      },
      {
        title: "Temporary Employees",
        tooltip:
          "Please select if this benefit is standard for all Temporary employees. Unselect if it's not offered.",
      },
      {
        title: "Significant location of operations",
        tooltip:
          "This section allows you to enter the organization's significant locations of operation where the listed benefit is offered to full-time or part-time employees.",
      },
    ],
  },
};
