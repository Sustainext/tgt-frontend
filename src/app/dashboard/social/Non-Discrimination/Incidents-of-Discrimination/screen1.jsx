  ...
  items: {
    ...
    properties: {
      ...
      totalnumberofincidentsofdiscrimination: {
        type: "string",
        title: "Total number of Incidents of discrimination",
      },
...
const uiSchema = {
  ...
  "ui:options": {
    titles: [
      ...
      {
        title: "Total number of Incidents of discrimination",
        title2: "totalnumberofincidentsofdiscrimination",
        tooltip:
          "Please specify the total number of incidents of discrimination on grounds  of race, color, sex, religion, political opinion, national extraction and social origin. ",
        display: "block",
        type: "number",
      },
      {
        title: "Describe the incident",
        title2: "describetheincident",
