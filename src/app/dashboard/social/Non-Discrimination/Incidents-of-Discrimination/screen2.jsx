  ...
  items: {
    ...
    properties: {
      ...
      Q3: {
        type: "string",
        title:
          "Specify the results of the remediation plans implemented with results reviewed through routine internal management review processes",
      },
...
const uiSchema = {
  items: {
    ...
    Q1: {
      ...
      "ui:tooltip":
        "How many number of incidents are reviewed by the organization. Please provide the details of the incidents reviewed. ",
    ...
    Q2: {
      ...
      "ui:tooltip":
        "Please describe the remediation plans that are being implemented (if any). ",
      "ui:tooltipdisplay": "block",
      "ui:widget": "inputWidget",
      "ui:horizontal": true,
      "ui:options": {
    ...
    Q3: {
      "ui:title":
        "3.Specify the results of the remediation plans implemented with results reviewed through routine internal management review processes",
      "ui:tooltip":
        "Please specify the remediation plans that have been implemented, with results reviewed through routine internal management review processes.",
      "ui:tooltipdisplay": "block",
      "ui:widget": "inputWidget",
      "ui:horizontal": true,
      "ui:options": {
    ...
    Q4: {
      ...
      "ui:tooltip":
        "Provide the list of incidents that are no longer subject to action. ",
      "ui:tooltipdisplay": "block",
      "ui:widget": "inputWidget",
      "ui:horizontal": true,
      "ui:options": {
