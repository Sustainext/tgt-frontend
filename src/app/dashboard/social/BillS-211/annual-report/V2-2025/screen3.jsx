...
const Screenthree = ({
  ...
  const options = [
    ...
    {
      label: "Tracking implementation and results",
      value: "Tracking implementation and results",
    },
    {
      label: "Communicating how impacts are addressed",
      value: "Communicating how impacts are addressed",
    },
    {
            ...
            {reportradio === "Yes" && (
              <div className="mb-5">
                <label
                  ...
                  htmlFor="username"
                >
                  5.1 If yes, which elements of the policies and/or due
