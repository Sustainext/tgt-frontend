          ...
          <form className="xl:w-[80%] lg:w-[80%] 2xl:w-[80%] md:w-[80%] 2k:w-[80%] 4k:w-[80%] w-[99%] text-left">
            <div className="mb-5">
              <label
                ...
                htmlFor="username"
              >
                9. Has the entity taken any measures to remediate any forced
              ...
              <div className="relative mb-1">
                ...
                <div className="mb-3">
                  ...
                  >
                    Not applicable, we have not identified any forced labour or
                    child labour in our activities and supply chains.
                  </label>
                  <br />
                </div>
              </div>
            ...
            {reportradio === "Yes" && (
              <div className="mb-5">
                <label
                  ...
                  htmlFor="username"
                >
                  9.1 If yes, which remediation measures has the entity taken?
