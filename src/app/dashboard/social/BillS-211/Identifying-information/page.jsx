...
const Identifyinginformation = ({ handleTabClick,setMobileopen,setSelectedOrgnew,setSelectedCorpnew,setYearnew,setActiveTab }) => {
        ...
        <div className="flex justify-between items-center border-b border-gray-200 mb-5 w-full">
          <div className="w-full">
            <div className="text-left mb-2 ml-3 pt-5">
              ...
              <div className="">
                <div className="h-[35px] flex pb-2">
                  <p className="gradient-text text-[22px] h-[52px] font-bold pt-1 w-full">
                    Bill S-211 - Fighting Against Forced Labour and Child Labour
                    in Supply Chains Act (Bill S-211)
                  </p>
                  <div className="float-end">
                  
                  <button onClick={handleBackToBILLs201} className="bg-transparent text-gray-900 text-[13px]   border border-gray-300  rounded-md flex w-[220px] me-2 py-2 gap-2 px-2 -mt-[10px]"> <MdChevronLeft className="mt-1"/> Back to Selecting Resolution </button>
