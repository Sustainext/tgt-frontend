...
const NoncomplianceincidentsMarketing = () => {
        ...
        <>
            ...
            <div className="flex flex-col justify-start overflow-x-hidden ">
                <div className="flex justify-between items-center border-b border-gray-200 mb-5 w-full">
                 ...
                 <div className="w-full float-end pt-5 me-1">
                        <div className="flex float-end border-l">
                            <button className="text-[#007EEF] bg-slate-200 rounded-full text-[11px] w-[72px] h-[22px] ml-2 text-center pt-0.5" onClick={() => toggleDrawer('75')}>GRI 417 - 3</button>
                ...
                <div className="ml-3 flex">
                    ...
                    Incidents of non-compliance concerning marketing communications (1/2)
