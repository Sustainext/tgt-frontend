...
const view_path = "gri-social-product_labeling-417-1b-number";
const client_id = 1;
const user_id = 1;
  ...
  items: {
    ...
    Q2: {
      "ui:title":
        "Total number of product or service categories covered by and assessed for compliance with such procedures.",
      "ui:tooltip":
        "Please specify the total number of product or service categories covered by and assessed for compliance with such procedures.",
      "ui:tooltipdisplay": "block",
      "ui:widget": "inputWidget",
      "ui:horizontal": true,
      "ui:options": {
