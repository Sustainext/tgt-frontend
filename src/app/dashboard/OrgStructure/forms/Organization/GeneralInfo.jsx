...
const GeneralInfo = ({ handleGeneralDetailsSubmit, heading, editData }) => {
  ...
  useEffect(() => {
    if (editData) {
      ...
      const selectedIndustryData = industryList.find(industry => industry.industry === selectedIndustryValue) || {};
      const subIndustriesForSelectedIndustry = selectedIndustryData?.subIndustries || [];
  ...
  const handleStateChange = (event) => {
    ...
    const citiesOfSelectedState = City.getCitiesOfState(selectedCountry, stateId);
    setCities(citiesOfSelectedState);
