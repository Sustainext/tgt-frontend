...
const QuickAddModal = ({ isOpen, onClose, type, parentNode }) => {
  ...
  // Helper function to render parent information cards
  const renderParentInfo = () => {
    ...
    return (
      <div className="mb-4">
        {type === "location" ? (
          // For locations, show both organization and corporate entity
          <div className="flex flex-col sm:flex-row sm:items-center justify-start sm:space-x-6 space-y-4 sm:space-y-0">
            <div className="flex flex-col">
              ...
              <div className="inline-block px-3 py-1 rounded-md text-sm bg-blue-100 text-blue-800">
                ...
                {/* This needs to be passed from OrgTree */}
              </div>
            </div>
            <div className="flex flex-col">
          ...
          // For corporate entities, show only organization
          <div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-[480px]">
        ...
        <button
          ...
          className="text-blue-600 text-sm hover:text-blue-700 mb-6"
        >
          Add More Details
        </button>
