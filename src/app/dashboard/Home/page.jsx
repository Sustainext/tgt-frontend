  ...
  return (
    ...
    <ToastContainer style={{ fontSize: "12px", zIndex: 1000 }} />
      <div className="xl:flex 2xl:flex lg:flex md:flex xl:space-x-3 lg:space-x-3 2xl:space-x-3 md:space-x-3 pe-4">
        ...
        <div className="row-span-2 col-start-2 row-start-1 rounded-lg shadow border h-[955px] border-gray-200 p-4 xl:w-3/5 lg:w-3/5 md:w-3/5 2xl:w-3/5 overflow-auto table-scrollbar">
          <Preferences />
        </div>
      </div>
    </>
