...
import { Oval } from 'react-loader-spinner'; // Correctly import the loader
  ...
  const fetchPreference = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `/select_preference/?preference=framework`);
      LoaderClose();
  ...
  return (
    <>
      ...
      <div className='px-6 mt-6'>
        <h2 className='text-2xl font-bold mb-8 text-gray-700'>Select Frameworks</h2>
