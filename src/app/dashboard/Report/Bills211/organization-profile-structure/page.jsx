...
const Organizationprofilestructure = forwardRef(
  ({ orgName, data, reportId }, ref) => {
    ...
    const fetchDatareport = async () => {
      try {
        ...
        const reportData =
          response.data.report_data.organization_profile_structure;
        if (reportData) {
    ...
    return (
      <>
        ...
        <div>
          ...
          {generateEntityDescriptionFromP1Q9() && (
            <p className="text-[15px] text-[#344054] mb-2 mt-3">
        ...
        <div className="xl:flex lg:flex md:flex 4k:flex 2k:flex 2xl:flex justify-between items-center">
          <p className="text-[15px] text-[#344054] mb-4 mt-3 w-[85%]">
            Add additional information about the Organization Structure
            including Control of other entities, including what the controlled
            entities do and where they are located (If applicable)
          </p>
          <button
