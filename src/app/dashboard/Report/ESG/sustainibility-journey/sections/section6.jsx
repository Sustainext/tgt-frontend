...
const Section6=({section10_3_2Ref,data})=>{
    ...
    return (
        ...
        Percentage of the procurement budget used for significant locations of operation that is spent on suppliers local to that operation
            ...
            <p className="text-sm mb-4">{data["204-1a"]?data["204-1a"]+" %":"No data available"}</p>


            <p className="text-[15px] text-[#344054] mb-2 font-semibold">
            The organization's geographical definition of "local"
            </p>
            <p className="text-sm mb-4">{data["204-1b"]?data["204-1b"]:"No data available"}</p>


            <p className="text-[15px] text-[#344054] mb-2 font-semibold">
            The definition used for "significant locations of operation"
            </p>
            <p className="text-sm mb-4">{data["204-1c"]?data["204-1c"]:"No data available"}</p>
        </div>
        </>
    )
}
