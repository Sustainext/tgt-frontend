...
const scrollToSection = (sectionRef, sectionId) => {
  ...
  const company_sustainability_statement = useSelector((state) => state.screen10Slice.company_sustainability_statement);
  const approach_for_sustainability = useSelector((state) => state.screen10Slice.approach_for_sustainability);
  const sustainability_goals = useSelector((state) => state.screen10Slice.sustainability_goals);
...
<div className="p-4 border border-r-2 border-b-2 shadow-lg rounded-lg h-[500px] top-36 sticky mt-2 w-[20%]">
            <p className="text-[11px] text-[#727272] mb-2 uppercase">10. Sustainability Journey </p>
            <p
