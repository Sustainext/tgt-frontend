...
Role of the highest governance body and of senior executives in overseeing the organization's 
due diligence and other processes to identify and manage the organization's impact on the economy, environment and people:
            </p>
            <p className="text-sm mb-4">{data["2_12_b"]?data["2_12_b"].Q1:"No data available"}</p>

            <p className="text-[15px] text-[#344054] mb-2 text-left font-semibold">
            How the highest governance body engage with stakeholders to support these processes:            </p>
            <p className="text-sm mb-4">{data["2_12_b"]?data["2_12_b"].Q3?data["2_12_b"].Q3:"No data available":"No data available"}</p>

            <p className="text-[15px] text-[#344054] mb-2 text-left font-semibold">
            How the highest governance body considers the outcomes of these processes:
            </p>
            <p className="text-sm mb-4">{data["2_12_b"]?data["2_12_b"].Q4:"No data available"}</p>
