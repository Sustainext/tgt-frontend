...
const Section9=({section9_3_3Ref,data})=>{
    ...
    return (
        ...
        <div id="section9_3_3" ref={section9_3_3Ref} >
            ...
            <p className="text-sm mb-2">{data["2_14_a_and_b"]?data["2_14_a_and_b"].highest_body_approves_report=="No"?data["2_14_a_and_b"].highest_body_approves_report:"":"No data available"}</p>
