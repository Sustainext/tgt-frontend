...
const Section10=({section9_3_4Ref})=>{
    ...
    return (
        ...
        <div id="section9_3_4" ref={section9_3_4Ref} >
            ...
            <p className="text-sm mb-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illo doloribus ipsum possimus laboriosam explicabo, omnis consequatur optio, quae at aut dolores, similique animi quisquam perferendis eos ad soluta natus ab.</p>
            <p className="text-[15px] text-[#344054] mb-4 text-left font-semibold">
