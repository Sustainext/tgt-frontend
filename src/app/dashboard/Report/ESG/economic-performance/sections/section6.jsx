...
const Section6=({section11_2_1Ref,data,reportType,
    sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'11.2.1':'',
  ...
  sectionOrder = 11,
    ...
    return (
        ...
        {reportType=='GRI Report: In accordance With' || (shouldRender && reportType==='Custom ESG Report')?(
         ...
         {data["3-3cde_11-2-1"] && data["3-3cde_11-2-1"].length > 0 ? (
           data["3-3cde_11-2-1"].map((val, index) => (
             <div key={index}>
