    ...
    <>
      <div id="section11_4_2" ref={section11_4_2Ref}>
        ...
        <p className="text-[15px] text-[#344054] mb-2">
          Our tax strategy is designed to support our business objectives while
          ensuring we meet our legal and ethical obligations. For xyz tax
          jurisdiction:
        </p>
        <p className="text-[15px] text-[#344054] mb-2">
          All tax jurisdictions where the entities included in the
          organization’s audited consolidated financial statements, or in the
          financial information filed on public record, are resident for tax
          purposes.
        </p>
