...
const Section16 = ({ section11_5Ref, section11_5_1Ref,data,reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'11.5.1':'',
