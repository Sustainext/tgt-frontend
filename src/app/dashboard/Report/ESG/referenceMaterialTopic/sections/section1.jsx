...
import ManagementOfMaterialTopicTable from '../table'

const JoditEditor = dynamic(() => import("jodit-react"), { ssr: false });


const Section1 =({section16Ref, orgName,data})=>{
   const col=[
        "Material Topic",
        "Policies, Commitments & Actions (Negative & Positive Impact)",
        "Tracking Effectiveness, Goals & Lessons Learned"
    ]
