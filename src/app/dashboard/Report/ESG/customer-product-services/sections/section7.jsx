    ...
    <>
      <div id="setion15_2_2" ref={section15_2_2Ref}>
       ...
       <p className="text-sm mb-4">
             {data["417_3b"]?data["417_3b"].length>0?data["417_3b"][0].Q1?data["417_3b"][0].Q1:"No data available":"No data available":"No data available"}
            </p>
        ...
        <div className="text-sm mb-4">
          <ul className="list-disc ml-4">
            <li className="text-[15px] text-[#344054] mb-2 font-semibold">
              ...
              <p className="mb-4 font-normal">{data["417_3a"]?data["417_3a"].data?data["417_3a"].data.length>0?data["417_3a"].data[0].Q1?data["417_3a"].data[0].Q1:"No data available":"No data available":"No data available":"No data available"}</p>
            </li>
            <li className="text-[15px] text-[#344054] mb-2 font-semibold">
              Number of Incidents of non-compliance with regulations resulting
              in a warning: 
              <p className="mb-4 font-normal">{data["417_3a"]?data["417_3a"].data?data["417_3a"].data.length>0?data["417_3a"].data[0].Q2?data["417_3a"].data[0].Q2:"No data available":"No data available":"No data available":"No data available"}</p>
            </li>
            <li className="text-[15px] text-[#344054] mb-2 font-semibold">
              Number of Incidents of non-compliance with voluntary codes: 
              <p className="mb-4 font-normal">{data["417_3a"]?data["417_3a"].data?data["417_3a"].data.length>0?data["417_3a"].data[0].Q3?data["417_3a"].data[0].Q3:"No data available":"No data available":"No data available":"No data available"}</p>
            </li>
          </ul>
        </div>
        <div className="text-sm mb-4">
