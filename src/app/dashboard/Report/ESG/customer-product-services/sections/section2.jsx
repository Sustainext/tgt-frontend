...
const Section2 = ({ section15_1_1Ref, data,reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'15.1.1':'',
  ...
  return (
    <>
      {reportType=='GRI Report: In accordance With' || (reportType==='Custom ESG Report' && shouldRender)?(
       <div ref={section15_1_1Ref} id="section15_1_1">
       <h3 className="text-[15px] text-[#344054] mb-4 text-left font-semibold">
        {sectionNumber} {sectionTitle}
       </h3>
       {data["3-3cde_15-1-1"] &&
       data["3-3cde_15-1-1"].length > 0 ? (
