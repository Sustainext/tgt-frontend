...
const Section28=({section13_7Ref,data})=>{
    ...
    const Tabledata2=data["2_30_a_analyse"]?data["2_30_a_analyse"]["collective_bargaining"].length>0?
...
:[
  {
     "Organisation/Corporation":"No data available",
       "Percentage of total employees covered by collective bargaining agreements":"No data available"
},
]:[
  {
   "Organisation/Corporation":"No data available",
...
13.7 Collective Bargaining
            ...
            <p className="text-sm mb-4">{data["2_30_b"]?data["2_30_b"].length>0?data["2_30_b"][0].Q1?data["2_30_b"][0].Q1:"No data available":"No data available":"No data available"}</p>
