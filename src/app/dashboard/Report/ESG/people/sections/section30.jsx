...
const Section30 = ({ section13_7_2Ref, orgName, data }) => {
  ...
  const loadContent = () => {
    dispatch(
      setFreedomOfAssociationViews(
        `We respect the rights of our employees to freedom of association and collective bargaining. We work to ensure that these rights are upheld across our operations and supply chain. At ${
  ...
  const Tabledata1 = data["407_1_analyse"]
    ? data["407_1_analyse"]["operation_bargaining"].length > 0
      ? data["407_1_analyse"]["operation_bargaining"].map((val, index) => {
          return {
            ...
            "Countries or Geographic Areas ":
              val["Countries or Geographic Areas"],
          };
        })
      : [
          {
  ...
  const Tabledata2 = data["407_1_analyse"]
    ? data["407_1_analyse"]["supplier_bargaining"].length > 0
      ...
      <div id="section13_7_2" ref={section13_7_2Ref}>
        ...
        <div className="xl:flex lg:flex md:flex 4k:flex 2k:flex justify-between">
          <p className="text-[15px] text-[#344054] mb-2 mt-3">
            Add statement about company’s views on freedom of association and
        ...
        <p className="text-[15px]  mb-2 font-semibold">
          Operations where workers' freedom of association or collective
          bargaining is at risk 
        </p>
