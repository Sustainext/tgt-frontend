...
const Section6 = ({ section13_1_5Ref, data, reportType }) => {
  ...
  const table1Data = data["405_1a_analyse"]
    ? data["405_1a_analyse"]["marketing_presence"]
      ? data["405_1a_analyse"]["marketing_presence"].length > 0
    ...
    data["202_1c"] && data["202_1c"].length > 0
      ? data["202_1c"]
          .map((item) => {
            ...
            const currencyValue =
              locationData.currencyValue || "No currency data available";
                ...
                return [
                  {
                    ...
                    Gender: "Male",
                    "Minimum Wage": wages.Male
                      ? wages.Male + ` ${currencyValue}`
                      : "No data available",
                  },
                  {
                    "Significant location of operations": locationName,
                    Gender: "Female",
                    "Minimum Wage": wages.Female
                      ? wages.Female + ` ${currencyValue}`
                      : "No data available",
                  },
                  {
                    "Significant location of operations": locationName,
                    Gender: "Non-binary",
                    "Minimum Wage": wages["Non-binary"]
                      ? wages["Non-binary"] + ` ${currencyValue}`
                      : "No data available",
                  },
                ];
              })
