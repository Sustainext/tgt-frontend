...
const Section7 = ({ section13_1_6Ref, data,reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'13.1.6':'13.1.5',
  sectionTitle = "Performance and Career Development Reviews of Employees", 
  sectionOrder = 13
 }) => {
