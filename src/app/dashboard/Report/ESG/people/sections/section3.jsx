...
const Section3=({section13_1_2Ref,data})=>{
    ...
    const Tabledata=data["401_social_analyse"]?data["401_social_analyse"]["data"]?data["401_social_analyse"]["data"]["new_employee_hires"].length>0?

    data["401_social_analyse"]["data"]["new_employee_hires"].map((val,index)=>{
        return (
...
const Tabledata2=data["401_social_analyse"]?data["401_social_analyse"]["data"]?data["401_social_analyse"]["data"]["employee_turnover"].length>0?

data["401_social_analyse"]["data"]["employee_turnover"].map((val,index)=>{
    return (
...
const columns1 = [
  ...
  const TableData3=data["2_7a_2_7b_analyse"]?data["2_7a_2_7b_analyse"]["total_number_of_employees"]?data["2_7a_2_7b_analyse"]["total_number_of_employees"].length>0?
