...
const People=forwardRef(({ onSubmitSuccess }, ref) => {
  ...
  const submitForm = async (type) => {
      LoaderOpen();
      const data={
      "employee_policies_statement":{"page":"screen_thirteen","label":"People","subLabel":"Add statement about company’s employees and their policies","type":"textarea","content":employee_policies_statement},
  "workforce_hire_retention_statement":{"page":"screen_thirteen","label":"Employee Hire, Turnover","subLabel":"Add statement about company’s workforce hire and retention","type":"textarea","content":workforce_hire_retention_statement} ,
  "standard_wage":{"page":"screen_thirteen","label":"Standard Wage","subLabel":"Add statement about company’s Policy on employee compensation","type":"textarea","content":standard_wage} ,
  "performance_review_process":{"page":"screen_thirteen","label":"Performance and Career Development Reviews of Employees","subLabel":"Add statement about company’s process for performance review of employees","type":"textarea","content":performance_review_process} ,
  "forced_labor_position":{"page":"screen_thirteen","label":"Forced or Compulsory Labour","subLabel":"Add statement about company’s position on forced / compulsory labor","type":"textarea","content":forced_labor_position} ,
  "child_labor_position":{"page":"screen_thirteen","label":"Incidents of Child Labour","subLabel":"Add statement about company’s position on child labor","type":"textarea","content":child_labor_position} ,
  "employee_diversity_position":{"page":"screen_thirteen","label":"Diversity of Governance Bodies and Employees","subLabel":"Add statement about company’s position on diversity of employees","type":"textarea","content":employee_diversity_position} ,
  "employee_skill_upgrade_programs":{"page":"screen_thirteen","label":"Programs for Upgrading Employee Skills and Transition Assistance Programs","subLabel":"Add statement about company’s programs for upgrading employee’s skills","type":"textarea","content":employee_skill_upgrade_programs} ,
  "remuneration_practices":{"page":"screen_thirteen","label":"Remuneration","subLabel":"Add statement about company’s remuneration practices & policies.","type":"textarea","content":remuneration_practices} ,
  "ohs_policies":{"page":"screen_thirteen","label":"Worker Participation, Consultation, and Communication on OHS","subLabel":"Add statement about company’s OHS policies","type":"textarea","content":ohs_policies} ,
  "hazard_risk_assessment": {"page":"screen_thirteen","label":"Hazard, Risk Identification and Investigation","subLabel":"Add statement about company’s process of Hazard and risk assessment","type":"textarea","content":hazard_risk_assessment},
  "work_related_health_injuries":{"page":"screen_thirteen","label":"Work-Related Ill-Health & Injuries","subLabel":"Add statement about work related ill health and injuries in company","type":"textarea","content":work_related_health_injuries} ,
  "safety_training":{"page":"screen_thirteen","label":"Safety Training","subLabel":"Add statement about company’s safety training","type":"textarea","content":safety_training} ,
  "ohs_management_system":{"page":"screen_thirteen","label":"Workers Covered by OHS Management System","subLabel":"Add statement about company’s OHS management system","type":"textarea","content":ohs_management_system} ,
  "freedom_of_association_views":{"page":"screen_thirteen","label":"Operations and Suppliers in Which the Right to Freedom of Association and Collective Bargaining May Be at Risk","subLabel":"Add statement about company’s views on freedom of association and collective bargaining","type":"textarea","content":freedom_of_association_views} ,
  "violation_discrimination_policy":{"page":"screen_thirteen","label":"Incidents of Violation/Discrimination","subLabel":"Add statement about company’s policy for addressing violation/ discrimination","type":"textarea","content":violation_discrimination_policy} ,
  "indigenous_rights_policy": {"page":"screen_thirteen","label":"Incidents of Violation of Rights of Indigenous People","subLabel":"Add statement about company’s policy on violation of rights of indigenous people","type":"textarea","content":indigenous_rights_policy} ,
  "parental_leaves": {"page":"screen_thirteen","label":"Parental Leaves","subLabel":"Add statement about company’s policy on parental leave","type":"textarea","content":parental_leaves} ,
  "security_personnel_external_training":{"page":"screen_thirteen","label":"Percentage of security personnel who have received formal training from third-party organisation","subLabel":"","type":"textarea","content":security_personnel_external_training},
  "security_personnel_internal_training":{"page":"screen_thirteen","label":"Percentage of security personnel who have received formal training in the organisation","subLabel":"","type":"textarea","content":security_personnel_internal_training}
