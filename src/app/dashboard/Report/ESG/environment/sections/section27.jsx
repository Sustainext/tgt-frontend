...
const Section27 = ({ section12_5_4Ref, data,reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'12.5.4':'12.5.3',
  sectionTitle = 'Waste Disposed',
  sectionOrder = 12,
 }) => {
