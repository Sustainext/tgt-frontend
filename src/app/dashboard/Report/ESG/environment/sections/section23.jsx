...
const Section23=({section12_4_5Ref,data})=>{
    ...
    const content = useSelector(state => state.screen12Slice.energy_consumption_reduction_commitment);
...
<EnergyTable columns={column1} data={Tabledata} consumption="Reduction in energy consumption total" unit1={reductionOfEnergyConsumption.unit1} total1={reductionOfEnergyConsumption.total1} unit2={reductionOfEnergyConsumption.unit2} total2={reductionOfEnergyConsumption.total2}/>
</div>
...
<div className="shadow-md rounded-md mb-4">
<EnergyTable columns={column2} data={Tabledata2} consumption="Total reduction in energy requirements of products and services" unit1={reductionOfEnergyService.unit1} total1={reductionOfEnergyService.total1} unit2={reductionOfEnergyService.unit2} total2={reductionOfEnergyService.total2}/>
</div>
