...
const Section21 = ({ section12_4_3Ref, data, reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'12.4.3':'12.4.2',
  sectionTitle = 'Energy Consumption Outside of the Organization',
  sectionOrder = 12,
 }) => {
