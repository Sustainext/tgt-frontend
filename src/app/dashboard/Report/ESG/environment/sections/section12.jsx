...
const Section12 = ({ section12_2_2Ref, data,reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'12.2.2':'12.2.1',
  ...
  const Tabledata = data["material_analyse"]
    ? data["material_analyse"]["recycled_materials"].length > 0
      ? data["material_analyse"]["recycled_materials"].map((val, index) => {
          return {
            "Types of recycled material used":
              val.type_of_recycled_material_used,
            "Percentage of recycled input materials used":
              val.percentage_of_recycled_input_materials_used,
          };
        })
      : [
          {
       ...
       {sectionNumber} {sectionTitle}
        ...
        <div className="xl:flex lg:flex md:flex 4k:flex 2k:flex 2xl:flex justify-between">
          <p className="text-[15px] text-[#344054] mb-2 mt-3">
            Add statement about company’s process for recycling
          </p>
          <button
