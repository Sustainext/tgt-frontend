...
const Section28 = ({ section12_5_5Ref, data, reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'12.5.5':'12.5.4',
  sectionTitle = 'Waste Diverted from Disposal',
  sectionOrder = 12,
 }) => {
  ...
  const Tabledata =
    data["waste_analyse"] &&
    data["waste_analyse"]["waste_diverted_from_disposal_by_material_type"]
      .length > 1
      ? data["waste_analyse"][
  ...
  const Tabledata2 =
    data["waste_analyse"] &&
    data["waste_analyse"]["non_hazardeous_waste_diverted_from_disposal"]
      .length > 1
      ? data["waste_analyse"][
          ...
          if (val.total_waste_generated !== undefined) {
            ...
            acc.push({
              ...
              "Preparation of reuse %":
                val.preparation_of_reuse_percentage + "%",
      ...
      <div id="section12_5_5" ref={section12_5_5Ref}>
       ...
       {sectionNumber} {sectionTitle}
        ...
        <p className="text-sm mb-4">
          We focus on diverting waste from disposal through recycling,
          composting, and other sustainable practices. Our initiatives aim to
          increase the proportion of waste diverted from landfills. 
        </p>
        ...
        <div className="shadow-md rounded-md mb-4">
          <WasteTable
            ...
            total={wasteDivertedDisposalMaterialType.total}
          />
        </div>
        ...
        <div className="shadow-md rounded-md mb-4">
          <WasteTable2
            ...
            total={hazardeousWasteDivertedFromDisposal.total}
          />
        </div>
        ...
        <div className="shadow-md rounded-md mb-4">
          <WasteTable2
            ...
            total={nonHazardeousWasteDivertedFromDisposal.total}
          />
        </div>
      </div>
    </>
