...
const Section5 = ({ section12_1_3Ref, data,reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'12.1.3':'12.1.2',
  sectionTitle = 'Scope 2 GHG Emissions',
  sectionOrder = 12,
 }) => {
    ...
    <>
      <div id="section12_1_3" ref={section12_1_3Ref}>
        ...
        <textarea
          ...
          rows={4}
        />
        <p className="text-[15px]  mb-2 font-semibold">Scope 2</p>
