...
const Section13=({section12_2_3Ref,data})=>{
    ...
    const content = useSelector(state => state.screen12Slice.reclamation_recycling_process);
    ...
    const Tabledata=data["material_analyse"]?data["material_analyse"]["reclaimed_materials"].length>0?
...
:[
    {
        ...
        "Percentage of reclaimed products and their packaging materials (%)":"No data available"
    }
]:[
    {
        "Type of Product":"No data available",
...
<div className="flex justify-between">
          <p className="text-[15px] text-[#344054] mb-2 mt-3">Add statement about company’s  reclamation and recycling process</p>
          <button
