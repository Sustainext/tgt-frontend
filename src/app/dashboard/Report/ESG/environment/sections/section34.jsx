...
const Section34 = ({ section12_7_1Ref, data,reportType,
  sectionNumber = reportType=='GRI Report: In accordance With' || reportType==='Custom ESG Report'?'12.7.1':'',
  ...
  return (
    <>
      ...
      {reportType=='GRI Report: In accordance With' || (shouldRender && reportType==='Custom ESG Report')?(
         ...
         {data["3-3cde_12-7-1"] && data["3-3cde_12-7-1"].length > 0 ? (
           data["3-3cde_12-7-1"].map((val, index) => (
             <div key={index}>
