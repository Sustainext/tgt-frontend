    ...
    <>
      <div className="mx-2 p-2">
        ...
        <div className="flex gap-4">
          ...
          {/* page sidebar */}
          <div className="p-4 border border-r-2 border-b-2 shadow-lg rounded-lg h-[550px] top-36 sticky  w-[20%] md:w-[25%] lg:w-[20%] hidden xl:block md:block lg:block 2k:block 4k:block 2xl:block">
