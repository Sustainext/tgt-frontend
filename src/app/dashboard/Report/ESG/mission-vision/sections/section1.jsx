  ...
  const dispatch = useDispatch();
    ...
    const loadContent = () => {
      dispatch(setMission(
        ...
        Climate Change<br/>
        ${orgName?orgName:"[Company Name]"} recognizes the urgent need to address climate change and is committed to--<br/>
        Nature<br/>
    ...
    return (
        ...
        {/* <p className="text-[15px] text-[#344054] mb-4">
          ...
          <p className="text-[15px] text-[#344054] mb-2 mt-3">Add statement about Mission, Vision and Values of the company</p>
          <button
