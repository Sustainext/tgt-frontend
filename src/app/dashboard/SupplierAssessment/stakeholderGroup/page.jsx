  ...
  const getStakeholderGroup = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get(
        `/supplier_assessment/stakeholder-group/`,
        {
          params: {
            page_size: rowsPerPage,
            ...(userFilter
              ? { created_by__email_in: userFilter }
              : { page: currentPage }),
          },
        }
      );
        ...
        <div className="relative xl:flex lg:flex 2xl:flex 4k:flex gap-4">
          <div className="w-full mb-4">
            ...
            <input
              ...
              placeholder="Search"
              className="pl-10 pr-4 py-1.5 flex items-center xl:min-w-[25vw] lg:min-w-[25vw] 2xl:min-w-[25vw] 4k:min-w-[25vw] w-full border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div className="w-full">
            ...
            >
              <div className="flex gap-1">
                <MdAdd className="w-4 h-4 mt-0.5" /> Create New Stakeholder
                Group
              </div>
            </button>
          </div>
