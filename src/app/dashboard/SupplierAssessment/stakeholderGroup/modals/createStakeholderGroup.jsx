    ...
    <>
      {isModalOpen && (
        <div className="fixed inset-0 flex justify-center items-center bg-[#00000080] z-50 mt-12">
         <div className="relative bg-white p-6 rounded-lg shadow-lg xl:w-[40%] md:w-[40%] lg:w-[40%] 2xl:w-[40%] 4k:w-[40%] 2k:w-[40%] w-[93%] max-w-3xl">
            {/* Header */}
            {groupCreated ? (
              <div>
                ...
                <p className="text-[#667085] text-[14px] mb-4">{`New Stakeholder group ${
                  groupName ? groupName : ""
                } has been created.`}</p>
                <div className="p-3 bg bg-[#F1F7FF] flex gap-2 rounded-md">
                  ...
                  <p className="text-[13px] text-[#051833]">
                    To send assessments to this group, at least one stakeholder
                    must be present in it. Click Add Now to include stakeholders
                    in the group.
                  </p>
                </div>
              ...
              <div>
                ...
                <p className="text-[#667085] text-[14px] mb-4">
                  Assessments are send to stakeholder groups. Create stakeholder
                  group and add stakeholders in it to send assessments.
                </p>
