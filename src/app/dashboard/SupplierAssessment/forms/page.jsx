  ...
  return (
    <div className="p-4 min-h-screen">
        ...
        <div className="relative xl:flex md:flex lg:flex 4k:flex 2k:flex  gap-4">
          <div className="w-full mb-4">
            ...
            <input
              type="text"
              placeholder="Search"
              className="pl-10 pr-4 py-1.5 xl:min-w-[25vw] lg:min-w-[25vw] 2xl:min-w-[25vw] 4k:min-w-[25vw] md:min-w-[89vw] w-full border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              // value={searchQuery}
      ...
      <p className="text-[14px] text-[#667085] mb-6">
        Create forms here to send in an assessment. Click + Create New Forms
        button to create forms.
      </p>
      ...
      {currentData.length > 0 ? (
        ...
        <NoDataAvailable
          title="No Forms Present"
          para="There are currently no forms available. Click on Create a New Form button to create forms."
