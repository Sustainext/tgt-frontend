...
export default function SettingsPanel({
  ...
  return (
    ...
    <div className='flex justify-center items-center min-h-screen px-6 py-6'>
      <div className='bg-white rounded-lg shadow-lg w-full max-w-[900px] max-h-[80vh] scrollable-content flex flex-col md:flex-row overflow-hidden'>
        {/* Desktop Sidebar */}
        {!isMobileView && (
