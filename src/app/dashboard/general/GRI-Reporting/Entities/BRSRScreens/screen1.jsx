...
const view_path = "brsr-general-org-details-holding-subsidiary-brsr-a-v-i-23a";
const client_id = 1;
const user_id = 1;
...
const schema = {
    ...
    items: {
      ...
      properties: {
        NameOfHoldingCompany: {
          type: "string",
          title: "Name of the Holding/Subsidiary/Associate Companies/Joint Ventures",
        },
  
        HoldingSubsidiary: {
          type: "string",
          title: "Holding/Subsidiary/Associate Company/Joint Venture",
           enum: [
            "Holding",
            "Subsidiary",
            "Associate company",
        ...
        PercentageShare: {
          type: "string",
          title: "% of Shares held by Listed Entity",
        },
        DoesHoldingCompanyParticipate: {
          type: "string",
          title: "Does the Holding/Subsidiary/Associate Companies/Joint Ventures participate in the Business Responsibility Initiatives of the listed entity?",
            enum:[
                "Yes",
                "No"
            ]
  ...
  const uiSchema = {
    ...
    "ui:options": {
      titles: [
        {
          key: "NameOfHoldingCompany",
          title: "Name of the Holding/Subsidiary/Associate Companies/Joint Ventures",
          tooltip:
            "<p>Specify the name of holding / subsidiary / associate companies / joint ventures",
          layouttype: "input",
          tooltipdispaly: "block",
        },
        {
          key: "HoldingSubsidiary",
          title: "Holding/Subsidiary/Associate Company/Joint Venture",
          tooltip:
            "Indicate whether the company is holding / subsidiary / associate companies / joint ventures",
          layouttype: "select",
          tooltipdispaly: "block",
        },
        {
          ...
          title: "% of Shares held by Listed Entity",
          tooltip:
            "What is the % of shares held by listed entity?",
          layouttype: "inputDecimal",
          tooltipdispaly: "block",
        },
        {
          key: "DoesHoldingCompanyParticipate",
          title: "Does the Holding/Subsidiary/Associate Companies/Joint Ventures participate in the Business Responsibility Initiatives of the listed entity?",
          tooltip:
            "Indicate whether the mentioned holding/subsidiary/associate companies/joint ventures (in 1st column) participate in the Business Responsibility initiatives of the reporting entity",
          layouttype: "select",
          tooltipdispaly: "block",
        },
        ...
        <div className="xl:mb-4 md:mb-4 2xl:mb-4 lg:mb-4 4k:mb-4 2k:mb-4 mb-6 block xl:flex lg:flex md:flex 2xl:flex 4k:flex 2k:flex">
          <div className="w-[100%] xl:w-[80%] lg:w-[80%] md:w-[80%] 2xl:w-[80%] 4k:w-[80%] 2k:w-[80%] relative mb-2 xl:mb-0 lg:mb-0 md:mb-0 2xl:mb-0 4k:mb-0 2k:mb-0">
           <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
             Holding, Subsidiary, Associate Companies and Joint Ventures
            </h2>
          </div>
