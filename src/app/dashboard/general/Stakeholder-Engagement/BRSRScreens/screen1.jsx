...
const view_path = "brsr-general-stakeholder-engagement-key-stakeholder-group-brsr-c-p4-ei-1";
const client_id = 1;
const user_id = 1;
...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      Q1: { type: "string", title: "Describe the Processes for Identifying Key Stakeholder Groups of the Entity" },
    },
  },
};
      ...
      titles: [
        {
          ...
          tooltip:
            "<p>Describe the processes used to identify key stakeholder groups of the entity</p>",
            ...
            Object.keys(r_schema || {}).length == 0 && (
             ...
             Describe the Processes for Identifying Key Stakeholder Groups of the Entity
              <MdInfoOutline
                ...
                data-tooltip-content="Describe the processes used to identify
 key stakeholder groups of the entity"
