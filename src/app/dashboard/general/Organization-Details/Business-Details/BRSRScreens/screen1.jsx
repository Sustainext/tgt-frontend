...
const view_path = "brsr-general-business-details-paid-up-capital-brsr-a-i-11";
const client_id = 1;
const user_id = 1;
...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      Q1: { type: "string", title: "Mention Paid-up Capital of the Entity (in INR)" },
    },
  },
};
...
const uiSchema = {
    ...
    "ui:options": {
      titles: [
        {
          key: "Q1",
          title: "Mention Paid-up Capital of the Entity (in INR)",
          tooltip:
            "<p>Enter paid-up capital of the listed entity as on end of the reporting period</p>",
