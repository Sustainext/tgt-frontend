...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      Q1: { type: "string", title: "What is the contribution of exports as a percentage of the total turnover of the entity?" },
    },
  },
};
...
const uiSchema = {
    ...
    "ui:options": {
      titles: [
        {
          key: "Q1",
          title: "What is the contribution of exports as a percentage of the total turnover of the entity?",
          tooltip:
            "<p>Indicate the percentage of the entity’s total turnover that is contributed by exports</p>",
...
const Screen6 = ({ selectedOrg, selectedCorp, year, togglestatus }) => {
          ...
          <div className="w-[100%] xl:w-[80%] lg:w-[80%] md:w-[80%] 2xl:w-[80%] 4k:w-[80%] 2k:w-[80%] relative mb-2 xl:mb-0 lg:mb-0 md:mb-0 2xl:mb-0 4k:mb-0 2k:mb-0">
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-content="This section documents data corresponding to the contribution 
of exports as a percentage of the entity's total turnover"
