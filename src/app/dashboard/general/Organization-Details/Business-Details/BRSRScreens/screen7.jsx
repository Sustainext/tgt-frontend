...
const view_path = "brsr-general-business-details-types-of-customers-brsr-a-iii-19-c";
const client_id = 1;
const user_id = 1;
...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      Q1: { type: "string", title: "A brief on types of customers" },
    },
  },
};
...
const uiSchema = {
    ...
    "ui:options": {
      titles: [
        {
          key: "Q1",
          title: "A brief on types of customers",
          tooltip:
            "<p>Provide details on types of customers of the entity</p>",
...
const Screen7 = ({ selectedOrg, selectedCorp, year, togglestatus }) => {
          ...
          <div className="w-[100%] xl:w-[80%] lg:w-[80%] md:w-[80%] 2xl:w-[80%] 4k:w-[80%] 2k:w-[80%] relative mb-2 xl:mb-0 lg:mb-0 md:mb-0 2xl:mb-0 4k:mb-0 2k:mb-0">
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-content="This section collects data corresponding to types of customers of the entity"
