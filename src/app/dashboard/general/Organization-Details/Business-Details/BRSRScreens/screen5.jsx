...
const view_path = "brsr-general-business-details-markets-served-brsr-a-iii-19-a";
const client_id = 1;
const user_id = 1;
...
const uiSchema = {
  ...
  "ui:options": {
    titles: [
      ...
      { key: "number", title: "Number", layout: "inputDecimal",
        tooltipdispaly:"block",
        tooltip:"Specify the number of locations served by the entity at the national level (No. of states) and international level (No. of countries) in the rows below"
      }
    ],
    rowLabels: [
      { title: "National (No. of States)",tooltipdispaly:"none",
        tooltip:"Enter number of plants/offices situated in India"
       },
      { title: "International (No. of Countries)",tooltipdispaly:"none",
...
const Screen5 = forwardRef(({ selectedOrg, year, selectedCorp,togglestatus }, ref) => {
