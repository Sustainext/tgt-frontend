...
const view_path = "brsr-general-workforce-employees-employees-brsr-a-iv-20-a";
const client_id = 1;
const user_id = 1;
...
const schema = {
  ...
  items: {
    ...
    properties: {
      ...
      percentageMaleEmployees: { type: "number", title: "Percentage of Male Employees" },
      femaleEmployees: { type: "number", title: "Number of Female Employees" },
      percentageFemaleEmployees: { type: "number", title: "Percentage of Female Employees" },
    }
  }
};
