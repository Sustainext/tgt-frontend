...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      employeeCategory: { type: "string", title: "Employee Category" },
      totalEmployees: { type: "number", title: "Total Employees" },
      maleEmployees: { type: "number", title: "Number of Male Employees" },
      percentageMaleEmployees: {
        type: "number",
        title: "Percentage of Male Employees",
      },
      femaleEmployees: { type: "number", title: "Number of Female Employees" },
  ...
  "ui:options": {
    titles: [
      ...
      },
      {
        ...
        tooltip:
          "Specify the total number of permanent and other then permanent employees working for the entity ",
          key1:"col2",
      },
      {
        key: "maleEmployees",
        ...
        tooltipdispaly: "block",
        tooltip:
          "Specify the total number of permanent and other then permanent male employees working for the entity ",
             key1:"col3",
      },
      {
        key: "percentageMaleEmployees",
        title: "Percentage of Male Employees",
        layout: "readonly",
        tooltipdispaly: "none",
        tooltip: "",
      ...
      },
      {
        ...
        tooltipdispaly: "block",
        tooltip:
          "Specify the total number of permanent and other then permanent female employees working for the entity ",
           key1:"col5",
      },
      {
        key: "percentageFemaleEmployees",
        title: "Percentage of Female Employees",
        layout: "readonly",
        tooltipdispaly: "none",
        tooltip: "",
...
const Screen1 = forwardRef(
  ({ selectedOrg, year, selectedCorp, togglestatus }, ref) => {
