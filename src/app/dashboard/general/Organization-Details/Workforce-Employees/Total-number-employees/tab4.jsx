...
const view_path = "gri-general-workforce_employees-2-7-a-b-full_time_employee";
const client_id = 1;
const user_id = 1;
...
const uiSchema = {
  ...
  "ui:options": {
    ...
    rowLabels: [{ title: "Male" }, { title: "Female" }, { title: "Others" }],
  },
};

const Tab4 = ({ fullName, selectedOrg, year, selectedCorp, togglestatus }) => {
