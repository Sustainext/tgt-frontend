...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      permanentWorkerGender: { type: "string", title: "Permanent Workers" },
      totalWorkersLeft: { type: "number", title: "Total Number Of Workers Who Left The Organization" },
      totalWorkersBeginning: { type: "number", title: "Total Number Of Workers (At The Beginning Of The Reporting Period)" },
      totalWorkersEnd: { type: "number", title: "Total Number Of Workers (At The End Of The Reporting Period)" },
