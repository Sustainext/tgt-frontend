...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      TypeofWorker: { type: "string", title: "Type of Worker",enum: ["Yes", "No"], },
      ...
      Workperformed: { type: "string", title: "Work performed",enum: ["Yes", "No"] },
      Engagementapproach: { type: "string", title: "Engagement approach",enum: ["Yes", "No"] },
      Thirdparty : { type: "string", title: "Third party (if applicable)",enum: ["Yes", "No"] },
    },
  },
};
    ...
    titles: [
      {
        ...
        tooltip: "Please select the types of workers employed or engaged by your organization during the reporting period.",
      },
      {
