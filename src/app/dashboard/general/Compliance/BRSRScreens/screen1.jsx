...
const schema = {
    ...
    items: {
      ...
      properties: {
        StakeholderGroup: {
          type: "string",
          title: "Stakeholder Group from whom Complaint is received",
          enum:[
            "Shareholders",
        ...
        NumberOfComplaint : {
          type: "string",
          title: "Number of Complaints filed during the year",
        },
        NumberOfComplaintPending : {
          type: "string",
          title: "Number of Complaints pending resolution at close of the year",
        },
        Remarks : {
          type: "string",
          title: "Remarks",
      ...
      titles: [
        {
          ...
          title: "Stakeholder Group from whom Complaint is received",
          tooltip:
            "<p>Specify name of the stakeholder group from which complaint is received</p>",
          layouttype: "select",
        ...
        },
        {
          ...
          title: "Grievance Redressal Mechanism",
          tooltip:
            "Does the organization have a Grievance Redressal Mechanism in place?",
          layouttype: "select",
          tooltipdispaly: "block",
        },
        {
        ...
        {
          key: "NumberOfComplaint",
          title: "Number of Complaints filed during the year",
          tooltip:
            "Specify number of complaints filed during the reporting year",
          layouttype: "inputonlynumber",
          tooltipdispaly: "block",
        },
        {
          key: "NumberOfComplaintPending",
          title: "Number of Complaints pending resolution at close of the year",
          tooltip:
            "Specify number of unresolved complaints at the end of the reporting year",
          layouttype: "inputonlynumber",
          tooltipdispaly: "block",
        },
        {
