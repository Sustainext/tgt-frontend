...
import StrategyPolicyPractices from './Strategy-policy-practices/page';
import {
  setHeadertext1,
  setHeadertext2,
  setHeaderdisplay,
  ...
  return (
    <div className='relative xl:flex lg:flex 2xl:flex 4k:flex justify-start'>
      ...
      {mobileopen ? (
        ...
        <div className='flex-1 ps-8 me-4 max-w-full overflow-hidden ms-6'>
          ...
          {activeTab === 'Tab2' && (
            <StrategyPolicyPractices setMobileopen={setMobileopen} />
          )}
        </div>
      )}
    </div>
