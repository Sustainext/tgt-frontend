      ...
      <table className="min-w-full border-collapse block md:table w-full rounded-lg overflow-hidden">
        <thead className="block md:table-header-group border">
          ...
          <tr className="gradient-background block md:table-row">
            ...
            <th className="p-2 text-slate-500 font-bold border-l border-t block md:table-cell text-[12px]">&gt;50 year old</th>
            <th className="p-2 text-slate-500 font-bold border-l border-t border-r block md:table-cell text-[12px]">Minority group</th>
            <th className="p-2 text-slate-500 font-bold border-l border-t border-r block md:table-cell text-[12px]">Vulnerable Communities</th>
          </tr>
        </thead>
