...
const Aside = ({ activeTab, handleTabClick, setMobileopen }) => {
  ...
  return (
    ...
    >
      <div className='flex items-start py-4 h-[calc(100vh-150px)] overflow-y-auto scrollable-content w-[199px] xl:min-w-[200px] lg:min-w-[200px] md:min-w-[400px] 4k:min-w-[200px] 2k:min-w-[200px] 2xl:min-w-[200px] min-w-[422px] rounded-lg text-[0.875rem]'>
