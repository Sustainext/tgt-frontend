  ...
  const fetchData = async (params) => {
    ...
    try {
      ...
      const formatGovernanceBodiesData = (data) => {
        return [
          {
            "Percentage of suppliers screened using social criteria": data.percentage.toFixed(2),
          },
        ];
      };
      ...
      const formatEmployeeCategoryData = (data) => {
        return [
          {
            "Percentage of suppliers having negative social impacts with which improvements were agreed upon": data.percentage_negative.toFixed(2),
            "Percentage of suppliers having negative social impacts with which services were terminated": data.percentage_improved.toFixed(2),
          },
        ];
      };
      ...
      setSuppliersocialassessment2(
        formatEmployeeCategoryData(negative_social_impacts_in_the_supply_chain_and_actions_taken)
      );
