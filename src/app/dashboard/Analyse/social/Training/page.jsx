...
import { column1, data1, data2 } from "./data";
import { yearInfo } from "@/app/shared/data/yearInfo";

const AnalyseTraining = ({ isBoxOpen }) => {
  const [averageHoursOfTraining, setAverageHoursOfTraining] = useState([]);
  const [employeesReceivingPerformanceReviews, setEmployeesReceivingPerformanceReviews] = useState([]);
  ...
  const fetchData = async (params) => {
    ...
    LoaderOpen();
    setAverageHoursOfTraining([]);
    setEmployeesReceivingPerformanceReviews([]);
    try {
      ...
      const {
        ...
        employees_receiving_regular_updates,
      } = data;

      setAverageHoursOfTraining(average_hours_of_training_provided_to_employees);
      setEmployeesReceivingPerformanceReviews(employees_receiving_regular_updates);
        ...
        <div className="mb-2 flex-col items-center pt-4 gap-6">
          <div className="mt-4 pb-3 mx-5 text-left">
            <div className="mb-2 flex-col items-center pt-2 gap-6">
              <div>Average hours of training per year per employee</div>
          ...
          <div className={`ps-4  w-[78%] me-4`}>
            <div className="mb-6">
              ...
              >
                ...
                <div className="mb-4">
                  <Table1 columns={column1} data={averageHoursOfTraining} />
                </div>
              </div>
            </div>
            <div className="mb-6">
              ...
              >
                ...
                <div className="mb-4">
                  <Table2 data={employeesReceivingPerformanceReviews} />
                </div>
              </div>
            </div>
          </div>
