     ...
     <div className="mb-2 flex-col items-center pt-4  gap-6">
      ...
      <div className="flex justify-between">
        <div className={`ps-4  w-[78%] me-4`}>
          <div className="mb-6">
            <p className="text-black text-[16px] ">Formal joint management-worker health and safety committees</p>
            <div
              id="ep1"
          ...
          <div className="mb-6">
            <p className="text-black text-[16px] ">Workers covered by an occupational health and safety management system </p>
            <div
              id="ep2"
              className="text-neutral-700 text-[15px] font-normal font-['Manrope'] leading-tight mb-3 "
            >
          ...
          <div className="mb-6">
            ...
            >
              ...
              <div className="mb-4">
                <DynamicTable2 columns={columns6} data={data6} />
              </div>
