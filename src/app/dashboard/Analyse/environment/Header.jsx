...
const Header = ({ activeTab, setIsBoxOpen, setMobileopen }) => {
  ...
  return (
    <>
      <div className='flex justify-between items-center  border-b border-gray-200 pb-4 relative z-40'>
...
transition-transform duration-300 ease-in-out z-[125] shadow-2xl px-2`}
        >
          {data &&
