    ...
    <div className="bg-white shadow-lg rounded-lg p-6 max-w-lg min-w-[444px] mx-auto">
      <div className="flex items-center space-x-2 mb-2">
        ...
        <h2 className="text-[18px] font-bold">
          {edit ? "User details saved" : "New User Added"}
        </h2>
      </div>
      <p className="text-gray-600 mb-6 text-[14px]">
        Select view all users to view or edit details of this user.
      </p>
      <div className="flex justify-between items-center mt-8">
        <div className="flex items-center space-x-2">
          ...
          <Link href="/dashboard" className="text-blue-600 text-[12px] flex">
            {" "}
            <MdOutlineHome className="me-2  text-[15px]" />
            Sustainext HQ
          </Link>
        </div>
        <div className="flex space-x-2 text-md">
          <Link
            ...
            className="bg-white hover:bg-white text-gray-700 px-4 py-1 rounded-lg border border-gray-10 text-[12px]"
          >
            View all Users
          </Link>
