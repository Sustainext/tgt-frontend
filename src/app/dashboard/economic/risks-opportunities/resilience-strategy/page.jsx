...
const Resiliencestrategy = ({ setMobileopen }) => {
  ...
  const tcfd = [
    {
      ...
      toggle: "147",
      id: "tooltip-$tcfd1",
      content: "TCFD-Strategy-C Disclosure",
    },
  ];
            ...
            data.map((program, index) => (
              <div key={index}>
                ...
                <div className="flex justify-between p-2 pt-5 pb-4 border-b-2 ">
                  <div className="ml-2 h-[65px]">{program.header}</div>
                ...
                <div className="hidden xl:block lg:block md:block 2xl:block 4k:block 2k:block 3xl:block">
                  <div className="h-[calc(100vh-70px)] overflow-y-auto custom-scrollbar p-2">
                    {program.data}
                  </div>
                </div>
...
export default Resiliencestrategy;
