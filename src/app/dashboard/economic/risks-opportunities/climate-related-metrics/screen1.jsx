...
const view_path = "economic-climate-risks-and-opportunities-climate-related-metrics";
const client_id = 1;
const user_id = 1;
        ...
        oneOf: [
          {
            properties: {
              ...
              Q3: {
                type: "string",
                title:
                  " If Yes, describe how these metrics are integrated into remuneration policies:",
              },
            },
          },
        ],
...
const uiSchema = {
  items: {
    ...
    Q2: {
      "ui:title":
        "Are climate-related performance metrics incorporated into remuneration policies?",
      "ui:tooltip":
...
const Screen1 = ({ selectedOrg, year, selectedCorp, togglestatus,setActiveTab }) => {
...
//   };
  ...
  const loadFormData2 = async () => {
    ...
    try {
      ...
      setRiskdata(response.data.data.climate_data);
      console.log(response.data.data.climate_data, "set data riskdata");
    } catch (error) {
                  ...
                  <div className="mt-1 mb-4">
                    <div className="flex items-start p-2 border-t-2 border-[#F98845] bg-orange-50 rounded">
                      ...
                      <div className="ml-3">
                        ...
                        To complete this section, please enter the required data in Climate related risks section.
                        </p>
