...
const view_path = "gri-economic-tax_governance_control_and_risk_management-207-2b-description";
const client_id = 1;
const user_id = 1;
...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "Provide a description of the mechanisms to raise concerns about the organization’s business conduct and the organization’s integrity in relation to tax.",
      },
