...
const Countrybycountryreporting = ({apiData}) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-start overflow-x-hidden ">
        <EconomicTopBar toggleDrawer={toggleDrawer} sdgData={sdgData} apiData={apiData} title={'Tax Transparency'} topic={'GovTaxTransparency'} />
        ...
        <div className="ml-3 flex relative">
          ...
          Country-by-country reporting
            <MdInfoOutline
              ...
              data-tooltip-content="This section documents the data corresponding to the country-by-country reporting."
...
export default Countrybycountryreporting;
