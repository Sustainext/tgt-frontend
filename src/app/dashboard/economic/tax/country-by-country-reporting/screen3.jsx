...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "The time period covered by the information reported in Disclosure 207-4.",
      },
...
const uiSchema = {
  items: {
    ...
    Q1: {
      ...
      "ui:tooltip":
        "Mention the time period covered by the information reported in this disclosure.",
