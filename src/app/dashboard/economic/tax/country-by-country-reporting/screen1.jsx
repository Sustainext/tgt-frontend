...
import Addmultisigleinput from "../../../../shared/widgets/Economic/addmultisigleinput";
const widgets = {
...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "Describe the approach to engagement with tax authorities.",
      },
...
const uiSchema = {
  items: {
    ...
    "ui:inputtype2": "text",
    "ui:widgetplaceholder2": "Enter Data",
           ...
           <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
            Please mention all tax jurisdictions where the entities included in the organization’s audited consolidated financial statements, or in the financial information filed on public record, are resident for tax purposes.
              <MdInfoOutline
               ...
               className="mt-1.5 ml-1 text-[15px] w-[20%] xl:w-[5%] md:w-[5%] lg:w-[5%] 2xl:w-[5%] 3xl:w-[5%] 4k:w-[5%] 2k:w-[5%]"
              />
              <ReactTooltip
                id={`es38`}
                place="top"
