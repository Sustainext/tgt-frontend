  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title:
          "If data are presented on a cash basis, provide the justification for this decision..",
      },
    },
  },
};
  ...
  items: {
    ...
    Q1: {
      "ui:title":
        "If data are presented on a cash basis, provide the justification for this decision.",
      "ui:tooltip":
        "Provide a justification for data presented on a cash basis decision in addition to reporting on the above basic components.",
...
to reporting on the above basic components."
                className="mt-1 ml-2 text-[16px] w-[20%] xl:w-[5%] md:w-[5%] lg:w-[5%] 2xl:w-[5%] 3xl:w-[5%] 4k:w-[5%] 2k:w-[5%]"
              />
              <ReactTooltip
                id={`es26`}
                place="top"
