...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "Percentage of salary contributed by employee or employer.",
      },
    },
  },
};
...
const uiSchema = {
  items: {
    "ui:order": ["Q1"],
    Q1: {
      "ui:title": "Mention the level of participation in retirement plans.",
      "ui:tooltip":
        "The level of participation in retirement plans such as participation in mandatory or voluntary schemes, regional, or country-based schemes, or those with financial impact.",
          ...
          <div className="w-[80%] relative">
           <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-html="The level of participation in retirement plans
