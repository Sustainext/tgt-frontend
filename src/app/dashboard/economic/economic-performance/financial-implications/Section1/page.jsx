            ...
            <div className="flex flex-col justify-start overflow-x-hidden ">
                <div className="flex justify-between items-center border-b border-gray-200 mb-5 w-full">
                    ...
                    <div className='w-full float-end '>
                        ...
                        <button className="text-[#007EEF] bg-slate-200 rounded-full text-[11px] w-[72px] h-[22px] ml-2 text-center pt-0.5" onClick={() => toggleDrawer('68')}>GRI 201 - 2</button>
                            <button className="text-[#fff] bg-[#48773C] rounded-full text-[11px] w-[72px] h-[22px] ml-2 text-center pt-0.5" onClick={() => toggleDrawer('69')}>SDG 13</button>
                ...
                <div className="ml-3 flex">
                    ...
                    Financial implications and other risks and opportunities due to climate change (1/2)
...
implications and other risks and opportunities due to climate change." className="mt-1.5 ml-2 text-[14px]" />
