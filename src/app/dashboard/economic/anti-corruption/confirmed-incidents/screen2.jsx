...
const view_path = "gri-economic_confirmed_incidents_of_corruption_and_actions_taken-205-3b-s2";
const client_id = 1;
const user_id = 1;
  ...
  items: {
    ...
    Q1: {
      "ui:title":
        "Total number of confirmed incidents in which employees were dismissed or disciplined for corruption.",
      "ui:tooltip":
        "Specify the total number of operations assessed for risks related to corruption.",
...
const Screen2 = ({ selectedOrg, year, selectedCorp,month,togglestatus }) => {
        ...
        <div className="flex mb-4">
          <div className="w-[80%] relative">
           <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
            Total number of confirmed incidents in which employees were dismissed or disciplined for corruption.
              <MdInfoOutline
                data-tooltip-id={`es32`}
                data-tooltip-html=
                "<p>Specify the total number of confirmed incidents in which employees were dismissed or disciplined for corruption.</p>"
