...
const uiSchema = {
  items: {
    ...
    Q2: {
      "ui:title": "Nature of confirmed incidents of corruption.",
      "ui:tooltip":
        "<p>Explain the nature of confirmed incidents of corruption. Confirmed incident of corruption: incident of corruption that has been found to be substantiated.</p>",
