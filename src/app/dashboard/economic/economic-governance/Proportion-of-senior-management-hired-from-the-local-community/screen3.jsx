...
const view_path = "gri-economic-proportion_of_senior_management-local-202-2c";
const client_id = 1;
const user_id = 1;
...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "The organization's geographical definition of 'local'",
      },
    },
  },
};
...
const uiSchema = {
  items: {
    "ui:order": ["Q1"],
    Q1: {
      "ui:title": "The organization's geographical definition of 'local'",
      "ui:tooltip":
        "<p>What is organization’s geographical definition of ‘local’?</p>",
         ...
         <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
          The organization's geographical definition of 'local'
              <MdInfoOutline data-tooltip-id={`es25`}
                data-tooltip-html="<p>What is organization’s geographical definition of ‘local’?</p>" className="mt-1.5 ml-2 text-[15px] w-[20%] xl:w-[5%] md:w-[5%] lg:w-[5%] 2xl:w-[5%] 3xl:w-[5%] 4k:w-[5%] 2k:w-[5%]" />
