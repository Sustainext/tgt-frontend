...
const view_path =
  "gri-economic-proportion_of_senior_management-senior_management-202-2b";
const client_id = 1;
const user_id = 1;
...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "The definition used for 'senior management'",
      },
    },
  },
};
...
const uiSchema = {
  items: {
    "ui:order": ["Q1"],
    Q1: {
      "ui:title": "The definition used for 'senior management'",
      "ui:tooltip":
        "<p>Mention the definition used for 'senior management'.</p>",
          ...
          <div className="w-[100%] xl:w-[80%] lg:w-[80%] md:w-[80%] 2xl:w-[80%] 4k:w-[80%] 2k:w-[80%] relative mb-2 xl:mb-0 lg:mb-0 md:mb-0 2xl:mb-0 4k:mb-0 2k:mb-0">
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-html="<p>Mention the definition used for 'senior management'.</p>"
