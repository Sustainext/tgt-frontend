...
const widgets = {
    TableWidget: CustomtextareaTableWidget,
...
const schema = {
    ...
    items: {
        type: 'object',
        properties: {
            CompletedLegalAction : { type: "string", title: "Completed Legal Action" },
            Status : { type: "string", title: "Status " },
            Decisionorjudgement: { type: "string", title: "Decision or judgement" },
...
const uiSchema = {
    ...
    'ui:options': {
        titles:
            [
                { title: "Completed Legal Action", tooltip: "Specify the legal actions.",type:"number" },
                { title: "Status", tooltip: "What is the status of the legal actions?",type:"number" },
                { title: "Decision or judgement", tooltip: "Specify the decision or judgement given on the mentioned legal action.",type:"number" },
            ...
            <div className="mx-2 p-3 mb-6 rounded-md" style={{ boxShadow: "rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px" }}>
                <div className='mb-4 flex'>
                    <div className='w-[80%] relative'>
                        ...
                        Mention main outcomes of completed legal actions, including any decisions or judgements
