  ...
  items: {
    ...
    properties: {
      ...
      Q2: {
        type: "string",
        title:
          "Report the nature of the critical concerns that were communicated to the highest governance body",
      },
    },
  },
};
          ...
          <div className="w-[80%] relative">
            <h2 className="flex mx-2 text-[15px] font-[500] mb-2">
              ...
              <MdInfoOutline
                ...
                data-tooltip-content="What is the total number of critical concerns that were communicated to the highest governance body during the reporting period."
