...
const uiSchema = {
  ...
  "ui:options": {
    ...
    rowLabels: [
      {
        title: "Views of stakeholders (including shareholders)",
        tooltip:
...
const Describewhether = ({ selectedOrg, selectedCorp, year, togglestatus }) => {
        ...
        <div className="mb-4 flex">
          <div className="w-[80%] relative">
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              Describe whether and how the following are taken into
              consideration for nomination and selection of highest governance
              body members:
            </h2>
          </div>
          <div className="w-[20%]">
