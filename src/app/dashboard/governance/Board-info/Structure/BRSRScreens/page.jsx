...
const schema = {
  ...
  items: {
    type: "object",
    properties: {
      Q1: { type: "string", title: "Does the entity have a specified Committee of the Board/ Director responsible for decision making on sustainability related issues?",enum:["Yes","No"] },
    },
  },
};
...
const uiSchema = {
    ...
    "ui:options": {
      titles: [
        {
          key: "Q1",
          title: "Does the entity have a specified Committee of the Board/ Director responsible for decision making on sustainability related issues?",
          tooltip:
            "<p>Indicate whether the entity has assigned a Committee of the Board/Director responsible for decision-making on sustainability-related issues",
          layouttype: "select",
