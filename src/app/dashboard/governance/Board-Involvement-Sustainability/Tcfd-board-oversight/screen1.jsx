...
const view_path = "governance-board-involvement-in-sustainability-boards-oversight-of-climate-related-risks-and-opportunities";
const client_id = 1;
const user_id = 1;
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title:
          "Describe how the board and/or board committees oversees climate-related issues such as risks and opportunities.",
      },
      Q2: {
        type: "string",
        title:
          "Mention the processes and frequency by which the board is informed about climate-related issues.",
      },
      Q3: {
        type: "string",
        title:
          ...
          <div className="w-[100%] xl:w-[80%] lg:w-[80%] md:w-[80%] 2xl:w-[80%] 4k:w-[80%] 2k:w-[80%] relative mb-2 xl:mb-0 lg:mb-0 md:mb-0 2xl:mb-0 4k:mb-0 2k:mb-0">
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-content="This section documents data corresponding to the Board's oversight of climate-related risks and opportunities, including the Board or Committee involved, their Reporting Frequency, the types of Climate Related Issues addressed (such as transition and physical risks, as well as opportunities), key Considerations in decision-making, and the processes for Monitoring and Oversight."
