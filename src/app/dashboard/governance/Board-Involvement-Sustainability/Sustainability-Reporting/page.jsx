            ...
            <div className="flex float-end border-l">
              ...
              <div className=" relative">
                <button
                  ...
                  data-tooltip-content="BRSR-Section C-Principle 4-Leadership Indicators-1"
        ...
        <div className="ml-3 flex relative">
          <h6 className="text-[17px] mb-4 font-semibold flex">
            ...
            <MdInfoOutline
              ...
              data-tooltip-content="This section documents the data corresponding to  the role of the highest governance bodyin sustainability reporting."
