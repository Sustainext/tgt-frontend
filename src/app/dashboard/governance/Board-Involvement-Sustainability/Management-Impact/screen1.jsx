...
statements, strategies, policies, and goals related to sustainable development." className="mt-1.5 ml-2 text-[14px]" />
                        ...
                        <h2 className="flex mx-2 text-[15px]  font-bold mb-2">Describe the role of the highest governance body and of senior executives in developing, approving, and updating the following: </h2>
