...
const view_path = "governance-risk-management-risk-identification-assessment-screen4";
const client_id = 1;
const user_id = 1;
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title:
          "Describe the process of assessing the potential size and scope of identified climate-related risks.",
      },
      Q2: {
        type: "string",
        title:
  ...
  items: {
    ...
    Q1: {
      "ui:title":
        "Describe the process of assessing the potential size and scope of identified climate-related risks.",
      "ui:tooltip":
        "Describe the criteria (financial impact, time horizon, value chain exposure, etc.) used to estimate the size and scope.",
    ...
    Q2: {
      ...
      "ui:title":
        "Provide definitions of risk terminology used or references to existing risk classification frameworks used.",
      "ui:tooltip":
        "Define terms like transition risk, physical risk, material risk, etc. and provide reference to risk classification framework used.",
      "ui:tooltipdisplay": "block",
...
const Screen4 = ({ selectedOrg, selectedCorp, year, togglestatus }) => {
          ...
          <div className="w-[100%] xl:w-[80%] lg:w-[80%] md:w-[80%] 2xl:w-[80%] 4k:w-[80%] 2k:w-[80%] relative mb-2 xl:mb-0 lg:mb-0 md:mb-0 2xl:mb-0 4k:mb-0 2k:mb-0">
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-content="This section documents data corresponding to the size and scope of identified climate-related risks."
