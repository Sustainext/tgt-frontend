...
const SustainabilityKnowledge = ({ setMobileopen }) => {
        ...
        <div className='ml-3 flex relative'>
          <h6 className='text-[17px] mb-4 font-semibold flex'>
            ...
            <MdInfoOutline
              ...
              data-tooltip-content='This section documents the data corresponding to the Collective knowledge of the highest governance body.'
