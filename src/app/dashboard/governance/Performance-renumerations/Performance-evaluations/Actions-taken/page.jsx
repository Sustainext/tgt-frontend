...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "Describe actions taken in response to the evaluations",
      },
    },
  },
};
...
const uiSchema = {
  items: {
    "ui:order": ["Q1"],
    Q1: {
      "ui:title": "Describe actions taken in response to the evaluations",
      "ui:tooltip":
        "While describing actions taken in response to the evaluations; Include: changes to the composition of the highest governance body and organizational practices.",
...
const ActionsTaken = ({ selectedOrg, year, selectedCorp, togglestatus }) => {
