  ...
  items: {
    ...
    properties: {
      ...
      Q2: {
        type: "number", // Changed from string to number
        title:
          "What is the median annual total compensation for all of the organization's employees excluding the highest-paid individual?",
      },
    },
  },
};
...
const AnnualAndMedian = ({ selectedOrg, selectedCorp, year, togglestatus }) => {
          ...
          <div className="w-[100%] xl:w-[80%] lg:w-[80%] md:w-[80%] 2xl:w-[80%] 4k:w-[80%] 2k:w-[80%] relative mb-2 xl:mb-0 lg:mb-0 md:mb-0 2xl:mb-0 4k:mb-0 2k:mb-0">
            <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                data-tooltip-content="This section documents the data corresponding to the annual total compensation & Median annual total compensation."
...
export default AnnualAndMedian;
