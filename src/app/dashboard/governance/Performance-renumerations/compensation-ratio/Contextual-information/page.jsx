...
const view_path = "gri-governance-compensation_ratio-2-21-c-contextual";
const client_id = 1;
const user_id = 1;
...
const ContextualInformation = ({selectedOrg,selectedCorp, year,togglestatus}) => {
          ...
          <div className="w-[100%] xl:w-[80%] lg:w-[80%] md:w-[80%] 2xl:w-[80%] 4k:w-[80%] 2k:w-[80%] relative mb-2 xl:mb-0 lg:mb-0 md:mb-0 2xl:mb-0 4k:mb-0 2k:mb-0">
           <h2 className="flex mx-2 text-[15px] text-neutral-950 font-[500]">
              ...
              <MdInfoOutline
                ...
                className="mt-1.5 ml-2 text-[15px] w-[5%] xl:w-[5%] md:w-[5%] lg:w-[5%] 2xl:w-[5%] 3xl:w-[5%] 4k:w-[5%] 2k:w-[5%]"
              />
              <ReactTooltip
                id={`tooltip-$e1`}
                place="top"
