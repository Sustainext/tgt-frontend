...
const schema = {
  ...
  items: {
    ...
    properties: {
      Q1: {
        type: "string",
        title: "Are the organization's policy commitments publicly available?",
        enum: ["Yes", "No"],
      },
      Q3: {
        type: "string",
        title:
          "If the policy commitments are not publicly available, explain the reason for this.",
      },
    },
    dependencies: {
      Q1: {
        oneOf: [
          {
            properties: {
              ...
              Q2: {
                type: "string",
                title:
                  "If yes, please provide  links to the policy commitments",
              },
            },
          },
        ],
...
const uiSchema = {
  items: {
    ...
    Q1: {
      "ui:title":
        "Are the organization's policy commitments publicly available?",
      "ui:tooltip":
    ...
    Q2: {
      "ui:title": "If yes, please provide  links to the policy commitments",
      "ui:tooltip":
        "What is the process for reviewing and approving the reported information.",
      "ui:tooltipdisplay": "none",
      "ui:widget": "inputWidget5",
      "ui:horizontal": true,
      "ui:options": {
        label: false,
      },
