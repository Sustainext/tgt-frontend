...
import HowBusinessEmbeds from './How-business-embeds/page';
import GovernancesTopBar from '../../governancesTopBar';
const ImplementingCommitments = ({ setMobileopen }) => {
        ...
        <div className='ml-3 flex relative'>
          <h6 className='text-[17px] mb-4 font-semibold flex'>
            ...
            <MdInfoOutline
              ...
              data-tooltip-content='This section documents the data corresponding to the embedding policy commitments.'
...
export default ImplementingCommitments;
