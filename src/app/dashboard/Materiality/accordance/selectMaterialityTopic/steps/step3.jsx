...
const Step3 = ({ handleTabClick, handlePrevious }) => {
    ...
    items: {
      ...
      properties: {
        Q1: {
          type: "string",
          title:
            "Are there any changes to the list of material topics compared to the previous reporting period?",
          enum: ["Yes", "No"],
        },
      },
      dependencies: {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = dataPresent
      ? `${process.env.BACKEND_API_URL}/materiality_dashboard/materiality-change-confirmation/${assessment_id}/`
      : `${process.env.BACKEND_API_URL}/materiality_dashboard/materiality-change-confirmation/create/`;
    try {
    ...
    <>
      <div className="mt-10">
        ...
        <div className="flex justify-end w-full gap-4 mt-4 mb-2">
          ...
          <button
            className="xl:w-[16%] h-full mr-4 py-2 px-2 bg-[#007EEF] text-white rounded-[8px] shadow cursor-pointer"
