...
import NitrogenOxideTable from "./nitrogenOxideTable";
    ...
    return (
      <>
        ...
        <AccordionItem
            ...
            tooltiptext={`This section documents the data corresponding to the Nitrogen oxides (NOx), sulfur oxides
(SOx), and other significant air emissions`}
            sdg={['GRI 305-7a','GRI 305-7b']}
            display="block"
            location={location}
          ...
          >
            ...
            <NitrogenOxideTable location={location} year={year} month={month}/>
          </AccordionItem>
