...
const view_path = 'gri-environment-waste-306-4e-contextual_info'
const client_id = 1
const user_id = 1
...
const Wastedivertedcontextualinformation = ({location, year, month}) => {
...
export default Wastedivertedcontextualinformation;
