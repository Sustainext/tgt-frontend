...
const view_path = 'gri-environment-waste-306-5e-contextual_info'
const client_id = 1
const user_id = 1
...
const Wastedirectedcontextualinformation = ({location, year, month}) => {
...
export default Wastedirectedcontextualinformation;
