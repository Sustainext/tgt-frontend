...
const view_path = 'gri-collect-waste-data_collection_method-306-3b-4e-5e-contextual_information'
const client_id = 1
const user_id = 1
...
const Datacollectionmethodologyimpact = ({ selectedOrg, year, selectedCorp }) => {
