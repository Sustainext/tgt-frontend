...
import Waterstresbody from "./water-stres-body"
const Waterstres = () => {
...
transition-transform duration-300 ease-in-out z-[100] shadow-2xl px-2`}>
            ...
            <Waterstresbody location={location} year={year} month={activeMonth} setLocationMessage={setLocationMessage} setYearMessage={setYearMessage} />
        </>
    );
};
export default Waterstres;
