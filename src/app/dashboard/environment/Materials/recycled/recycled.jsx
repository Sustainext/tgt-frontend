                ...
                <div className="flex justify-between items-center border-b border-gray-200 mb-5 w-full">
                    ...
                    <div className='w-full float-end '>
                        <div className="flex float-end border-l">
                            <button className="text-[#007EEF] bg-slate-200 rounded-full text-[11px] w-[72px] h-[22px] ml-2 text-center pt-0.5" onClick={() => toggleDrawer('38')}>GRI 301-2</button>
                            <button className="text-[#fff] bg-red-900 rounded-full text-[11px] w-[72px] h-[22px] ml-2 text-center pt-0.5" onClick={() => toggleDrawer('39')}>SDG 8</button>
                            <button className="text-[#fff] bg-yellow-600 rounded-full text-[11px] w-[72px] h-[22px] ml-2 text-center pt-0.5 " onClick={() => toggleDrawer('40')}>SDG 12</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="ml-3 flex">
                    <h6 className="text-[17px] mb-4 font-semibold flex">
                        ...
                        <MdInfoOutline data-tooltip-id={`tooltip-$e1`}
                            ...
                            of goods/services during the reporting period." className="mt-1.5 ml-2 text-[14px]" />
...
transition-transform duration-300 ease-in-out z-[100] shadow-2xl px-2`}>
            ...
            setYearMessage={setYearMessage}
             />
            <Recycledbody location={location} year={year} month={activeMonth} setLocationMessage={setLocationMessage} setYearMessage={setYearMessage} />
        </>
    );
};
