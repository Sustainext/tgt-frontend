...
const Aside = ({ activeTab, handleTabClick }) => {
  ...
  return (
    <div className="m-3 ml-2 p-2 border border-r-2 border-b-2 shadow-lg rounded-l min-h-[110vh]">
                ...
                <div className="bg-white px-2 ml-5 3xl:ml-8 mt-2 border-l-2 border-gray-300">
                  ...
                  <div>
                    <p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Waste diverted to disposal"
                      ? "text-blue-400"
                      : "bg-transparent text-[#727272] "
                      }`} onClick={() => handleTabClick("Waste diverted to disposal")}>Waste Directed to disposal</p></div>
