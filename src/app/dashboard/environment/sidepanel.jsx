...
const Aside = ({ activeTab, handleTabClick }) => {
  ...
  return (
    <div className="m-3 ml-2 p-2 border border-r-2 border-b-2 shadow-lg rounded-l">
      <div className="flex items-start py-4 min-h-[84vh] rounded-lg text-[0.875rem] overflow-x-hidden sm:w-[200px] md:w-[200px] lg:w-[200px] xl:w-[220px] 2xl:w-[200px] 3xl:w-[351px] scrollable-content">
        <div className="flex flex-col w-full font-medium">
          ...
          >
            ...
            >
              ...
              <div className="inset-y-0 -right-2 flex items-center pointer-events-none">
              <MdKeyboardArrowDown className={`text-lg text-neutral-500${isEnergySectionVisible && "rotate-i80"}`}/>
          ...
          >
            ...
            >
              ...
              <span className="text-left sm:w-[92px] md:w-[92px] lg:w-[92px] xl:w-[92px] 2xl:w-[92px] 3xl:w-[198px]">Waste</span>
              <div className="inset-y-0 -right-2 flex items-center pointer-events-none">

              <MdKeyboardArrowDown className={`text-lg text-neutral-500${isWasteVisible && "rotate-i80"}`}/>
              </div>
            </button>
          ...
          >
           ...
           <GiWoodPile  className="w-5 h-5 mr-2" />
              ...
              <span className="text-left sm:w-[92px] md:w-[92px] lg:w-[92px] xl:w-[92px] 2xl:w-[92px] 3xl:w-[198px]">Materials</span>
              <div className="inset-y-0 -right-2 flex items-center pointer-events-none">
              <MdKeyboardArrowDown className={`text-lg text-neutral-500${isMaterialsVisible && "rotate-i80"}`}/>
              </div>
            </button>
            ...
            {isMaterialsVisible && (
              <>
                <div className="bg-white px-2 ml-5 3xl:ml-8 mt-2 border-l-2 border-gray-300">
                  ...
                  <div><p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Materials used by weight or volume"
                    ? "text-blue-400"
                    : "bg-transparent text-[#727272]"
                    }`} onClick={() => handleTabClick("Materials used by weight or volume")}> Materials used by weight or volume</p></div>
                  <div><p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Recycled input materials used"
                    ? "text-blue-400"
                    : "bg-transparent text-[#727272] "
                    }`} onClick={() => handleTabClick("Recycled input materials used")}>Recycled input materials used</p></div>
                  <div><p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Reclaimed products and their packaging materials"
                    ? "text-blue-400"
                    : "bg-transparent text-[#727272] "
                    }`} onClick={() => handleTabClick("Reclaimed products and their packaging materials")}>Reclaimed products and their packaging materials</p></div>
          ...
          >
            <button
              ...
              ${activeTab === "Interaction with water as shared resource" ||
                  activeTab === "Water Withdrawal and Water Discharge from All Areas" ||
                  activeTab === "Water withdrawal/Discharge from areas with water stress" ||
            ...
            >
              ...
              <span className="text-left sm:w-[92px] md:w-[92px] lg:w-[92px] xl:w-[92px] 2xl:w-[92px] 3xl:w-[198px]">Water and effluents</span>
              <div className="inset-y-0 -right-2 flex items-center pointer-events-none">
              <MdKeyboardArrowDown className={`text-lg text-neutral-500${isWaterVisible && "rotate-i80"}`}/>
              </div>
            </button>
            ...
            {isWaterVisible && (
              <>
                <div className="bg-white px-2 ml-5 3xl:ml-8 mt-2 border-l-2 border-gray-300">
                  <div><p className="text-[12px]  ml-3  text-gray-400">Topic management disclosure</p></div>
                  <div>
                    <p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Interaction with water as shared resource"
                      ? "text-blue-400"
                      : "bg-transparent text-[#727272] "
                      }`} onClick={() => handleTabClick("Interaction with water as shared resource")}>Interaction with water as shared resource</p>
                  </div>
                  <div><p className="text-[12px]  ml-3  text-gray-400">Topic Disclosure</p></div>
                  <div>
                    <p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Water Withdrawal and Water Discharge from All Areas"
                      ? "text-blue-400"
                      : "bg-transparent text-[#727272] "
                      }`} onClick={() => handleTabClick("Water Withdrawal and Water Discharge from All Areas")}> Water Withdrawal and Water Discharge from All Areas</p>
                  </div>
                  <div>
                    <p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Water withdrawal/Discharge from areas with water stress"
                      ? "text-blue-400"
                      : "bg-transparent text-[#727272]"
                      }`} onClick={() => handleTabClick("Water withdrawal/Discharge from areas with water stress")}>Water withdrawal and Water Discharge from areas with water stress</p>
                  </div>

                  <div>
                    <p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Substances of concern"
                      ? "text-blue-400"
                      : "bg-transparent text-[#727272] "
                      }`} onClick={() => handleTabClick("Substances of concern")}>Substances of concern</p>
                  </div>
                  <div>
                    <p className={`flex  text-start ml-4 px-2 py-2  focus:outline-none w-full text-[12px] cursor-pointer ${activeTab === "Change in water storage"
                      ? "text-blue-400"
                      : "bg-transparent text-[#727272] "
                      }`} onClick={() => handleTabClick("Change in water storage")}>Change in water storage</p></div>
