...
const Aside = ({ activeTab, handleTabClick }) => {
  ...
  return (
    <div className="m-3 ml-2 p-2 border border-r-2 border-b-2 shadow-lg rounded-l">
      <div className="flex items-start py-4  h-[84vh] rounded-lg text-[0.875rem] overflow-x-hidden sm:w-[200px] md:w-[200px] lg:w-[200px] xl:w-[190px] 2xl:w-[200px] 3xl:w-[351px] scrollable-content">
