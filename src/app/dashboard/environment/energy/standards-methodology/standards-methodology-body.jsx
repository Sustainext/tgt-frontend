...
const Standardsmethodologybody = ({location, year, month,setLocationMessage, setYearMessage}) => {
    ...
    <>
      <div className="mx-3">
       ...
       title="Standards, methodologies, assumptions and calculation tools used"
          ...
          sdg={['GRI 302-1f','GRI 302-2b','GRI 302-2b','GRI 302-4d','GRI 302-5c']}
          display="none"
          location={location}
...
export default Standardsmethodologybody;
