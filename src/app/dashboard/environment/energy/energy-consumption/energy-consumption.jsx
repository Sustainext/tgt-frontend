            ...
            <div className="flex flex-col justify-start overflow-x-hidden ">
                ...
                <div className="ml-3 flex">
                    <h6 className="text-[17px] mb-4 font-semibold flex">
                        ...
                        <MdInfoOutline data-tooltip-id={`tooltip-$e1`} data-tooltip-content="This section documents data corresponding to the renewable and/or non-renewable materials used in the production of goods/services during the reporting period." className="mt-1.5 ml-2 text-[14px]" />
...
transition-transform duration-300 ease-in-out z-[100] shadow-2xl px-2`}>
            ...
            activeMonth={activeMonth}
                ...
                setYearMessage={setYearMessage}
                 />
            <EnergyConsumptionBody location={location} year={year} month={activeMonth} setLocationMessage={setLocationMessage} setYearMessage={setYearMessage} />
        </>
    );
};
