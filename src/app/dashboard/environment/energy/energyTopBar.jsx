...
const EnergyTopBar = ({ toggleDrawer, sdgData, apiData, griData, brsr,setMobileopen }) => {
  const toggleSidebar = () => {
    setMobileopen(true);
  };
    ...
    <>
      <div className="hidden xl:block lg:block md:hidden 2xl:block 4k:block">
        <div className="flex justify-between items-center border-b border-gray-200 mb-5 w-full">
          ...
          {/* desktop version */}
          <div className="w-full float-end pt-5 me-1 hidden xl:block lg:block md:block 2xl:bolck 4k:block">
