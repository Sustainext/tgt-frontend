  ...
  return (
    <>
      <div className="xl:mx-3 lg:mx-3 md:mx-3 2xl:mx-3 4k:mx-3 2k:mx-3 mx-1">
        <AccordionItem
          title="Products & Services in organisation's supply chain with Significant Impact on Biodiversity"
          tooltiptext={`This section documents data corresponding to the products & services in organisation's supply chain with the most significant impacts on biodiversity.
`}
          sdg={[
            "GRI 101-5d",
            "GRI 101-6e",
