...
import Screen4comp from './components/screen4comp'
...
const Screen4 = ({ year, selectedOrg, selectedCorp, setOrgMessage, togglestatus }) => {
  return (
    <div className="xl:mx-3 lg:mx-3 md:mx-3 2xl:mx-3 4k:mx-3 2k:mx-3 mx-1">
      <AccordionItem
        title="Details of Offset "
        tooltiptext="This section documents data corresponding to the goals, the geographic location, whether and how principles of good offset practices are met, whether and how the offset is certified or verified by a third party for each offset."
        sdg={["GRI 101-2c"]}
        display="block"
        selectedOrg={selectedOrg}
        setOrgMessage={setOrgMessage}
      >
        <Screen4comp selectedOrg={selectedOrg} selectedCorp={selectedCorp} year={year} togglestatus={togglestatus} />
      </AccordionItem>
    </div>
  );
};
