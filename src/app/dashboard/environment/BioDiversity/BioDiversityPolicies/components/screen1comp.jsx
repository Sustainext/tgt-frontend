...
const schema = {
    ...
    items: {
      ...
      properties: {
        Q1: {
          type: "string",
          title: "Does the organization have a formal biodiversity policy or commitments?",
          enum: ["Yes", "No"]
        },
        Q3: {
          type: "string",
          title: "Are the organization's policies or commitments aligned with the 2050 Goals and 2030 Targets of the Kunming-Montreal Global Biodiversity Framework?",
          enum: ["Yes", "No"]
        }
      },
      dependencies: {
          ...
          oneOf: [
            {
              properties: {
                ...
                Q2: {
                  type: "string",
                  title: "Describe organisation's policies or commitments to halt and reverse biodiversity loss."
                },
                Q3: {
                  type: "string",
                  title: "Are the organization's policies or commitments aligned with the 2050 Goals and 2030 Targets of the Kunming-Montreal Global Biodiversity Framework?",
          ...
          oneOf: [
            {
              properties: {
                ...
                Q4: {
                  type: "string",
                  title: "Explain how these policies or commitments are informed by the 2050 Goals and 2030 Targets in the Kunming-Montreal Global Biodiversity Framework."
                }
              }
            },
            {
              properties: {
                ...
                Q5: {
                  type: "string",
                  title: "If not, provide a brief statement of the fact to comply with the requirement."
                }
              }
            }
          ]
  ...
  const uiSchema = {
    items: {
      ...
      Q2: {
        ...
        "ui:title": "Describe organisation's policies or commitments to halt and reverse biodiversity loss.",
        "ui:tooltip":
          "Provide a high-level description of organisation's policies or commitments to halt and reverse biodiversity loss.",
        "ui:tooltipdisplay": "block",
      ...
      Q4: {
        "ui:title":
          "Explain, how these policies or commitments are informed by the 2050 Goals and 2030 Targets in the Kunming-Montreal Global Biodiversity Framework.",
        "ui:tooltipstitle":
      ...
      Q5: {
        "ui:title":
          "If not, provide a brief statement of the fact to comply with the requirement.",
        "ui:tooltipstitle":
          "f the policies or commitments to halt and reverse biodiversity loss are not informed by the 2050 Goals and 2030 Targets in the Global Biodiversity Framework, a brief statement of this fact is sufficient to comply with the requirement. The organization can explain if it intends to do so and, if so, by which timeframe.",
        "ui:titlediplay": "block",
