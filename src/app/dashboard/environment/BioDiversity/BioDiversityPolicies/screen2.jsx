  ...
  return (
    ...
    >
      ...
      <div className="xl:flex md:flex lg:flex 2xl:flex 4k:flex block xl:items-center lg:items-center md:items-center 2xl:items-center 4k:items-center  justify-center relative">
        <MdInfoOutline
          data-tooltip-id={`tooltip-${title.replace(/\s+/g, '-')}`} data-tooltip-html={tooltiptext} className="mt-1 text-[14px]" style={{display:display}} />
        {/* Tooltip */}
...
const Screen2 = ({ year, selectedOrg, selectedCorp, setOrgMessage, month, togglestatus }) => {
  return (
    <div className="xl:mx-3 lg:mx-3 md:mx-3 2xl:mx-3 4k:mx-3 2k:mx-3 mx-1">
      <AccordionItem
        title="Scope of Policy Application"
        tooltiptext="<p>This section documents  data corresponding to the extent to which these 
policies or commitments apply to the organization’s activities and to 
its business relationships.</p> <p>Business relationships:</p>
<p>relationships that the organization has with business partners, 
with entities in its value chain including those beyond the first tier, 
and with any other entities directly linked to its operations, products, or services.</p>"
        sdg={["GRI 101-1b"]}
        display="block"
