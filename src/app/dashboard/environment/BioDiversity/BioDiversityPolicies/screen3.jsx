...
const Screen3 = ({ year, selectedOrg, selectedCorp, setOrgMessage, month, togglestatus }) => {
  return (
    <div className="xl:mx-3 lg:mx-3 md:mx-3 2xl:mx-3 4k:mx-3 2k:mx-3 mx-1">
      <AccordionItem
        title="Goals and targets"
        tooltiptext="This section documents data corresponding to the report the 
goals and targets to halt and reverse biodiversity loss, 
whether they are informed by scientific consensus, the base year, 
and the indicators used to evaluate progress."
        sdg={["GRI 101-1c"]}
        display="block"
        selectedOrg={selectedOrg}
        setOrgMessage={setOrgMessage}
      >
        <Screen3comp selectedOrg={selectedOrg} selectedCorp={selectedCorp} year={year} togglestatus={togglestatus} />
      </AccordionItem>
    </div>
  );
};
