...
const Habitatprotected = ({ apiData, isSidepanelOpen,setMobileopen }) => {
  const {
    corporate_id,
    organization_id,
    materiality_year,
      ...
      <div className="flex flex-col justify-start overflow-x-hidden ">
        ...
        Habitat Protected or Restored
            <MdInfoOutline
              ...
              data-tooltip-content="TThis section documents data corresponding to the all habitat areas protected or restored."
...
export default Habitatprotected;
