  ...
  (
    ...
    const handleVirtualChange = useCallback(
      (e) => {
        ...
        dispatch(
          updateScopeDataLocal({ scope: 2, data: { data: updatedFormData } })
        );
    ...
    useEffect(() => {
      const currentErrors = validationErrors?.scope2?.fields;
      ...
      validationErrors?.scope2?.fields,
      containerHeight,
      itemHeight,
      formData.length,
    ]);
