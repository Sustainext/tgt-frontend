...
const view_path = "gri-environment-emissions-consolidation_approach_q1";
const client_id = 1;
const user_id = 1;
    ...
    items: {
      ...
      properties: {
        Q1: {
          type: "string",
          title:
            "Please select the consolidation approach considered by the organisation.",
            enum:["Equity share","Financial control","Operational control"]
        },
      },
    },
  };
