                    ...
                    if (property.format !== 'data-url') {
                      return (
                        ...
                        {property.enum && (key === 'Category' || key === 'Subcategory' || key === 'Activity') ? (
                          <select
                            className="block w-[120px] py-2 text-sm leading-6 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5 border-b-2 border-gray-300"
                            value={row[key] || ''}
                            onChange={(e) => {
                              const updatedRows = [...rows];
                            ...
                            {key === 'Unit' && (
                              ...
                              <div className="absolute right-1 top-0.5">
                                ...
                                <span className="absolute right-2 top-4 ml-2 transform -translate-y-1/2 pointer-events-none text-white">
                                  <MdArrowDropDown  className={`text-xs`} />
                                </span>
                              </div>
