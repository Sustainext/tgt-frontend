const nextConfig = {
    env: {
        ...
        NEXT_APP_TRACK_URL: 'https://app.powerbi.com/view?r=eyJrIjoiMmEyNTEzNjItNjJkZi00ZDg0LTliOGEtNThmZDA5OTgxOGY1IiwidCI6ImIwZjhlODRjLWU0YTgtNDc5OS04MWIwLWRmMTUwMDY0MDM3ZCJ9%22',
